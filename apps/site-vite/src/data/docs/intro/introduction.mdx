...
Tamagui supports cross-browser server-side rendering ([see how we do it with Next.js](https://github.com/tamagui/tamagui/tree/master/apps/site)), even for responsive styles and variants.
