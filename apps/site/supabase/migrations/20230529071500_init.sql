...
CREATE UNIQUE INDEX github_tokens_pkey ON public.github_tokens USING btree (id);
...
alter table "public"."github_tokens" add constraint "github_tokens_pkey" PRIMARY KEY using index "github_tokens_pkey";
...
alter table "public"."github_tokens" add constraint "github_tokens_id_fkey" FOREIGN KEY (id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."github_tokens" validate constraint "github_tokens_id_fkey";
