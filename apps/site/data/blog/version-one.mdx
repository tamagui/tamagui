...
[**Tamagui Core**](#overview-of-tamaguicore) (`@tamagui/core`) is a style library for React Native and web that supports 100% of the React Native API surface in a 0-dependency library. It adds all the [goodies of modern style libraries](#overview) into a cohesive package.
