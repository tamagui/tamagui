...
description: Cross-platform frontend apps 2x faster, with ½ the code.
by: nate
# relatedIds:
#   - 'tamagui-alpha'
---
...
<IntroParagraph>
  Tamagui is style system for React Native + web, taken to the next level thanks to an optimizing
  compiler. It outputs beautifully platform-targeted code through advanced code analysis and
  transformation. The end result is that you can [ship faster, share more code, and get better
