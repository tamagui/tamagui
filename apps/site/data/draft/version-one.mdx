...
I love working on Tamagui, and there's a wealth of super useful, practical work that's clearly aheead. The plan is to grow things slowly and to stay nearly completely OSS.

Subscribers will get early access to the source and packages of in-development features, and early access to some exciting apps that are in development:
