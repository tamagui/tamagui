...
<IntroParagraph large>
  ...
  re-write](/docs/intro/why-a-compiler).
</IntroParagraph>
...
[Static](/docs/intro/why-a-compiler) is the optimizing compiler. It supports web and native through a plugin interface that has adapters for Webpack, Vite, Next, React Native, and Expo. Over a dozen major improvements to the compiler have made their way in since beta. Some of the highlights are:
