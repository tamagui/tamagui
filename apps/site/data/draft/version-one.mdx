...
I love working on Tamagui, and there's a wealth of concrete ways for it to mature. I'd like to take things slowly, and for Tamagui to stay OSS (and I think those two are related).

So for now it's fully funded by Github Sponsors. I'm setting it up like this:

Sponsors get early access to new features, nightlies, a private chat room, and to beta test some incredible upcoming dev-tools:

- 📚 **Docs** - Give your design system and UI kit a beautiful docs site just like tamagui.dev, without setup.
- 🖼️ **Studio** - A frontend realtime editor for colors, themes, tokens, default styles and more. Hooks into your app at runtime and exports to git-friendly JSON. Import/export to Figma:
...
- An in-development new starter that goes further than Solito at unifying web and native.
- `tamagui build` to output pre-process your entire app and output js and css, so you can avoid any plugin and get compat with many more bundlers.
