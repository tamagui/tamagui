...
A special thanks to [Codingscape](https://codingscape.com), [BeatGig](https://beatgig.com), and [QuestPortal](https://www.questportal.com) for their early large sponsorships ❤️. And a big thank you to all the individual sponsors!

A huge thanks to [Radix](https://www.radix-ui.com/), [Floating UI](https://floating-ui.com/), [Moti](https://moti.fyi), and [Framer Motion](https://github.com/framer/motion) for their inspiration and snippets of code that helped bring Tamagui across the line.
