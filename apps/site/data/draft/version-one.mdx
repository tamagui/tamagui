...
We've expanded our testing signficantly: more tests, automated releases, stricter linting and fuller integration tests. The internal `release.ts` script checks many more common pitfalls.
...
The next few minor releases will focus on improving types, accessibility, animations, test coverage, and solidifying the newer components.
...
I love working on Tamagui and would like to make this project work financially long-term. I'm hesitant to take VC money when I think there's a clear path to profitability by growing it slowly.

The plan is to build out a few things, all three of which I've made significant progress towards:

- 🥡 Takeout. Well-made components, screens, color palettes and themes, plus well packages icons and fonts.
- 📚 Docs. Give your design system and UI kit a beautiful docs site just like tamagui.dev, without setup.
- 🖼️ Studio - A frontend realtime editor for colors, themes, tokens, default styles and more. Hooks into your app at runtime and exports to git-friendly JSON. Import and export to Figma.

The plan is to keep these projects OSS, with a delayed open source model and optional cloud hosting. I think this is a fair model, so I'm giving it a shot.

Basically, **sponsors get early access to all of this**. There will also be early-releases of in-development components too, and high level sponsors get chat support and priority bugfixes.

Please do consider sponsoring Tamagui development!
