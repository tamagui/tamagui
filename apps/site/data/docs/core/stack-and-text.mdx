...
Stack and Text are functionally equivalent to React Native `View` and `Text`, they just accept the superset of [props](/docs/styling/props) that Tamagui supports.
