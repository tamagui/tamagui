...
And then you'll want to set `outputCSS` as documented in the [Compiler docs](/docs/intro/compiler) and import the CSS that the Tamagui compiler emits somewhere from your app.

[See the Next.js guide](/docs/guides/next-js) for further documentation on how to set it up.
