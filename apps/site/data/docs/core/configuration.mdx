...
Tamagui website) by
[copying and pasting this gist](https://gist.github.com/natew/3be503cc5990a1142d17ffadf86a134f)
...
### Troubleshooting
---
My custom fonts aren't appearing in Tamagui components?

- `Font family` definition is important based on device i.e. Web vs Native
  - Native requires a single string with the font family defined, whereas web can include fallback font families.

Try adding this to your custom font inside the `createFont` function:
```tsx
