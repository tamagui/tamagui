  ...
  data={[
    {
      ...
      required: false,
      type: 'TamaguiAllowedStyleValueSettings',
...
_TamaguiAllowedStyleValueSettings_:
...
- boolean - allows any string (or number for styles that accept numbers)

```tsx
type AllowedStyleValueSettingBase = boolean | 'strict' | 'somewhat-strict'

type AllowedStyleValuesSettingSize = AllowedStyleValueSettingBase | 'number' | 'percent'
type AllowedStyleValuesSettingZIndex = AllowedStyleValueSettingBase | 'number'
type AllowedStyleValuesSettingRadius = AllowedStyleValueSettingBase | 'number'
type AllowedStyleValuesSettingColor = AllowedStyleValueSettingBase | 'named'
...
type AllowedStyleValuesSetting =
  | AllowedStyleValueSettingBase
  | AllowedStyleValuesSettingPerCategory
```

_AutocompleteSpecificTokensSetting_:
