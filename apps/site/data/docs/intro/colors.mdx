...
<Notice>
  ...
  palette](https://github.com/tamagui/tamagui/blob/master/packages/themes/src/tokens.tsx).
  ...
  See
  [@tamagui/colors](https://github.com/tamagui/tamagui/tree/master/packages/colors/src)
