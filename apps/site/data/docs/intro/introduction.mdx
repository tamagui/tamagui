...
<Grid>
  ...
  />
  <RouteCard title="Core" href="" description="Core hooks and utilities" />
  <RouteCard
    title="Components"
  ...
  <RouteCard
    ...
    description="How to properly use Tamagui's styled properties, creating styled components, and more"
  />
  <RouteCard title="Extras" href="/docs/extras/overview" description="Icons, constants, helpers, and more" />
</Grid>
...
Using [createTamagui](/docs/core/configuration) you can generate a fully-typed design system with colors, tokens, spacing, sizing, fonts, themes, shorthands, animations, and more, that work with well-optimized and easy to use hooks like [useMedia](/docs/core/use-media) and [useTheme](/docs/theme/use-theme).
...
There's a lot to it, and good reasons it exists, but are [discussed more on the compiler introduction](/docs/compiler/why-a-compiler).
