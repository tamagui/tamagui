...
A lightweight (20Kb) yet complete CSS-in-JS library, design system library, and base components and hooks that work to bridge thme together.

It works on top of React Native and React Native Web (or our minimal fork, [react-native-web-lite]()).
