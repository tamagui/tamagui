...
<IntroParagraph>
  Tamagui is a complete suite of libraries for building UI's that run well on both React
  for web, and React Native. It consists of three layers that work together:
</IntroParagraph>
...
[Read in-depth on how it works and how fast it is here](/docs/intro/why-a-compiler).
