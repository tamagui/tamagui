...
<Notice theme="green">
  If using VSCode, use [VSCode Icons](https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons) file icon theme to get custom tamagui icon for `tamagui.config.ts`.
</Notice>
