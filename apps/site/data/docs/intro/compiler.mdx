...
The web is more sensitive to performance, especially when it comes to Javascript, and the CSS-in-JS strategy that React Native Web uses basically forces you to keep all your styles in JS. This is generally a bad thing. Browsers really want you to use CSS, especially for anything interactive. Further, React Native lacks many concept important to CSS features that make web apps feel great.
