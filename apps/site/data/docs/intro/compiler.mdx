...
You can define your own "feels native" and set the Y axis appropriately, make small if you want.
...
With React Native Web today it's hard to share more than a pretty small fraction of your frontend without immediately sacrificing look and feel. This is mostly because of the web. The web is extra sensitive to performance, especially when it comes to Javascript, and the CSS-in-JS needs compilers to avoid shipping a lot more of it.
