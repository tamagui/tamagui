...
<IntroParagraph>
  ...
  **frontend development trilemma** by choosing two of three:
</IntroParagraph>

<YStack w="100%" mih={500} als="center" $gtMd={{ my: '$4' }}>
  <Image
    title="The Frontend Trilemma: Choose two of: Write less code, Ship a native-feeling app, and share code between platforms"
    src="/trilemma.svg"
    size="hero"
    height={270 * 2}
    width={320 * 2}
