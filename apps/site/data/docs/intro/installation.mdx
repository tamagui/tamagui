...
You'll also need to alias `react-native` to `react-native-web` (or `react-native-web-lite` if you're feeling adventurous and want better concurrent mode support and a more up to date RN Animated driver):
...
- [Webpack](/docs/compiler/install#webpack)
- [Next.js](/docs/compiler/install#nextjs) ([guide](/docs/guides/next-js))
- [Vite](#vite) ([guide](/docs/guides/vite))
- [Metro](/docs/compiler/install#babel--metro)
