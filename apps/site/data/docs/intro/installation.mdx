...
We also have more in depth guides for [Next.js](https://tamagui.dev/docs/guides/next-js), [Expo](https://tamagui.dev/docs/guides/expo) and [Vite](https://tamagui.dev/docs/guides/vite).
