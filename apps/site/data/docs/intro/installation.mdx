...
export default function App() {
  return (
    <Tamagui.Provider>
      ...
      <Suspense>{/* The rest of your app here */}</Suspense>
    </Tamagui.Provider>
  )
}
```

Tamagui.Provider has optional props, [see the docs for them here](/docs/intro/configuration#using-tamagui-provider).
