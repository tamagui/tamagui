...
Tamagui require this to work out of the box, but eventually you'll probably want to add one of the plugins which automates a variety of these types of compatibility fixes and features, alongside the optimizing compiler.
