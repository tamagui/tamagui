...
If you want a complete set of components designed to build universal apps, use `tamagui`. If you want to build out your own components and don't want any of the tamagui components, you can just use `@tamagui/core`. This document uses `tamagui` as an example, but if you are using `@tamagui/core` you can swap out the import.
