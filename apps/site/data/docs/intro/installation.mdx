...
<WideTabs id="configs" defaultValue="vite">
<WideTabs.List>
    <WideTabs.Tab value="vite">Vite</WideTabs.Tab>
    <WideTabs.Tab value="expo">Expo</WideTabs.Tab>
    <WideTabs.Tab value="next">Next.js</WideTabs.Tab>
    <WideTabs.Tab value="webpack">Webpack</WideTabs.Tab>
    <WideTabs.Tab value="metro">Metro</WideTabs.Tab>
</WideTabs.List>

<WideTabs.Content value="vite">
    ...
    1. Create a new [Vite](https://vitejs.dev/guide/#scaffolding-your-first-vite-project) project:

     ```bash
    npm create vite@latest
    ```

    2. Remove `"type": "module"` from your `package.json` if you have it. (The type module support was removed because it was breaking metro, webpack or something).
    3. Add `@tamagui/vite-plugin`
    4. And update your `vite.config.ts`:
...
<WideTabs.Content value="expo">
    ...
    1. Create a new [Expo](https://docs.expo.dev/get-started/create-a-project/#initialize-a-new-project) project

    ```bash
    npx create-expo-app -t expo-template-blank-typescript
    ```

    2. Add `@tamagui/babel-plugin`:

    ```bash
    yarn add @tamagui/babel-plugin
    ```
    
    3. Update your `babel.config.js` to include the optional `@tamagui/babel-plugin`:
    ...
    2. Load your fonts for React Native to recognize them. There are several ways to do this:

    <Spacer size="$6" />

    <Tabs id="font" defaultValue="tamagui">
    <Tabs.List>
        <Tabs.Tab value="tamagui">Tamagui</Tabs.Tab>
        <Tabs.Tab value="expo">Expo Google Fonts</Tabs.Tab>
    </Tabs.List>
    <Separator />

    <Spacer size="$6" />

    <Tabs.Content value="tamagui">
...
<WideTabs.Content value="next">
    ...
    1. Create a new [Next.js](https://nextjs.org/docs/getting-started/installation) project
...
<WideTabs.Content value="webpack">
