...
We recommend [spending time understanding your Core configuration optiona](/docs/core/configuration) from here, skipping over the Compiler setup. The compiler is optional and should be saved for setting up after you've built something you'd like to test it with.
