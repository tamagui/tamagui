...
<Notice>
  ...
  [Props documentation](/docs/styling/props).
</Notice>
...
To learn more about to use them and all the special types, [see the docs on variants](/docs/styling/variants).
