...
This is a more advanced use for building custom hooks or components, but you can pass in a theme name and a component theme name (as [discussed here](/docs/theme/theming#component-subset-themes)) to grab the right subset theme:
