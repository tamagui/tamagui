...
More than just text in a box, a button needs icons, themes, variants, sizes, loading indicators, several pseudo states, and a delicate balance between sub-components' positions, spacing and style. All of this delivered in a simple API that still allows complete customization.
