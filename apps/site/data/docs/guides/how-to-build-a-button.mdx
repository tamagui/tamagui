...
It's not just some text in a box. Beyond varying colors and a few levels of importance to indicate, you'll often have multiple sizes, the ability to display icons (before or after text), a loading indicator... not to mention all delicate internal spacing and styling that must work across the base, focused, hovered and pressed states.
