...
Tamagui helps make this possible, and maybe even easy, as of version `1.28` with the introduction of `createStyledContext`.

We think it makes designing composable components APIs a joy, so we made this guide to show why composable components are useful, how to design them, and how `createStyledContext` helps achieve simplicity without sacrificing control.
