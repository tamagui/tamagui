...
It's more than just some text in a box. Beyond varying colors and levels of importance to indicate, you often have sizing, icons (displayed before or after), a loading indicator and... well, a lot of delicate internal spacing and styling to balance across the base, focused, hovered, pressed and disabled states - all of which needs to coordinate across the aformentioned frame, text and icon.
