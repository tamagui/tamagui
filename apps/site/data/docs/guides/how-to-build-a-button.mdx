...
Tamagui allows for building a button with "composable components," a concept
...
so we wrote this guide to show off building more advanced composable component
APIs. While this guide covers a button, this is applicable to many types of UI
components.

So what are composable components? Simply, it's when you have, say, a
...
<Notice>
  This guide is more of a primer on designing composable components, teaching
...
Abstracting the tree structure that's output is our problem. The composable
...
So we want our composable component API both for ergonomics and for performance,
...
some of the benefits of and ideas behind composable components.
...
But we'd that encourage you to give the composable component API a try and see
how you like it.
