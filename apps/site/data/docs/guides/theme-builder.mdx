...
Palettes are great for a design system because they constrain you. They force you to choose a limited set of colors to work with, and then build up from there. Designs look better when they have consistency.

#### Templates

The next level up is a template. A template is incredibly simple: it maps a _name to a color_, specifically it maps a name in your theme to an offset within your palette. As usual, it's best illustrated visually:
