...
You should run `npm create tamagui-app@latest` which bootstraps a verly nicely configured Next.js app where you can take or leave whatever you want.
...
<Notice>
  Make sure the Tamagui style tag always comes after the `getStyleElement` style tag to ensure
  Tamagui styles override built-in `react-native-web` ones.
</Notice>
