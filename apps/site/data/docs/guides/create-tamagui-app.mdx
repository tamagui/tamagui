...
We have two templates available:

- `next-expo-router` Expo, Expo Router, Solito, and Next.js
- `next-expo-solito` Expo, React Navigation, Solito and Next.js

### Usage

```bash
npm create tamagui -t next-expo-router
npm create tamagui -t next-expo-solito
```
