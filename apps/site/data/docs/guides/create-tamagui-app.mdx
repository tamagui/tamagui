...
- Learning - Client-only web app with Webpack or Vite. Useful to understand how to set up tamagui.config.ts.
- [Takeout](/takeout) - A more robust, paid starter kit we provide more support for.
