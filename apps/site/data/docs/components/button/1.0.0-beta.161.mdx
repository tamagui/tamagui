...
Button only supports a limited subset of text props directly, and doesn't accept `hoverStyle` text props. If you need more control, you can do a simple customization:

```tsx
import { forwardRef } from 'React'
import { styled, themeable, ButtonFrame, ButtonText, useButton, ButtonProps } from 'tamagui'
...
export const Button = forwardRef<TamaguiElement, ButtonProps>(themeable((propsIn, ref) => {
