...
<Highlights
  features={[
    ...
    'Offers headless and styled variations.'
  ]}
/>

### Usage

Depending on your use case, you may choose to go with our customized button or use headless for full customizability.
...
This is a temporary section for notes and todos while developing headless.

- [ ] TODO: share size from context
- [ ] TODO: update the docs after the headless API is approved
- [ ] TODO: implement `<Button.Icon>`
