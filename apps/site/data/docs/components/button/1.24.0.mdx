...
ButtonFrame extends Stack views inheriting all the [Tamagui standard props](/docs/intro/props).

### ButtonTextFrame

ButtonTextFrame extends [`SizableText`](/docs/components/text#sizabletext)
