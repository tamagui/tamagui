...
import { Toast, ToastProvider, useToast } from 'tamagui' // or @tamagui/toast
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      descriptions: `Options for the burnt package if you're using native toasts on mobile`,
    },
    {
      name: `notificationOptions`,
      required: false,
      type: `NotificationOptions`,
      descriptions: `Options for the notification API if you're using native toasts on web`,
    }
  ]}
/>
...
const MyComponent = () => {
  return (
    <Toast> // goes to default viewport
      // ...
    </Toast>
  )
}
...
const MyComponent2 = () => {
  return (
    <Toast viewportName="viewport-custom">
      // ...
    </Toast>
  )
}
