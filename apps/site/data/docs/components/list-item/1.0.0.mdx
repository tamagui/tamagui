...
Frame of the ListItem, extends [ThemeableStack props](/docs/components/stacks#themeablestack)
...
Wrapper of `ListItem.Title` and `ListItem.Subtitle`, extends [View props](/docs/core/stack-and-text#props)
`ListItem.Title` extends
