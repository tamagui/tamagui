...
Stack props accept [every prop from react-native-web](https://necolas.github.io/react-native-web/docs/view/) View, as well as all [the style properties Tamagui supports](/docs/styling/props).
...
To see all the style properties supported, see the [Props](/docs/styling/props) documentation.
...
Beyond the [Tamagui Props](/docs/styling/props), stacks have two variants
