...
<Description>Use to toggle between two states.</Description>
...
Using the `useSwitch` API, you can make your own Switch from scratch. You could even do it without Tamagui's styling system if you wanted to.
