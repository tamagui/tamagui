...
<CodeBlockWithTabs>
  ...
  <div id="bun">
  ```bash margin=false
  bun add @tamagui/dialog
  ```
  </div>

  <div id="pnpm">
  ```bash margin=false
  pnpm add @tamagui/dialog
  ```
  </div>
</CodeBlockWithTabs>
...
Contains every component for the dialog. Beyond [Tamagui Props](/docs/styling/props), adds:
...
Just [Tamagui Props](/docs/styling/props).

### Dialog.Portal

Renders Dialog into appropriate container. Beyond [Tamagui Props](/docs/styling/props), adds:
...
Beyond [Tamagui Props](/docs/styling/props), adds:
...
Displays behind Content. Beyond [Tamagui Props](/docs/styling/props), adds:
