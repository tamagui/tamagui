...
<PropsTable
  data={[
    ...
    {
      name: 'onInteraction',
      type: `(type: 'select' | 'focus' | 'hover', layout: TabTriggerLayout | null) => void`,
...
Here is a demo with more advanced animations using [AnimatePresence](/docs/core/animations#animatepresence-and-exitstyle) and [Trigger](#trigger) events
