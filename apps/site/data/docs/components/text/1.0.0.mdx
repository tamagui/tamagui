...
Text in Tamagui matches to Text in react-native-web, just with the added [Tamagui Props](/docs/styling/props).
...
It uses [spread variants](/docs/styling/styled#spread-variants) to achieve this.
