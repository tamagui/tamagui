...
<CodeBlockWithTabs>
  ...
  <div id="bun">
  ```bash margin=false
  bun add @tamagui/linear-gradient
  ```
  </div>

  <div id="pnpm">
  ```bash margin=false
  pnpm add @tamagui/linear-gradient
  ```
  </div>
</CodeBlockWithTabs>
...
LinearGradient extends YStack, inheriting [Stack props](/docs/components/stacks) and therefore the [Tamagui standard props](/docs/styling/props), plus:
