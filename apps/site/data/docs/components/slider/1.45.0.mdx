...
<CodeBlockWithTabs>
  ...
  <div id="bun">
  ```bash margin=false
  bun add @tamagui/slider
  ```
  </div>

  <div id="pnpm">
  ```bash margin=false
  pnpm add @tamagui/slider
  ```
  </div>
</CodeBlockWithTabs>
...
`Slider.Track` Inherits `SizableStack`, extending all the default [props](/docs/styling/props).

### Slider.TrackActive

`Slider.Track` Inherits `Stack`, extending all the default [props](/docs/styling/props).

### Slider.Thumb

`Slider.Track` Inherits `SizableStack`, extending all the default [props](/docs/styling/props), adding:
