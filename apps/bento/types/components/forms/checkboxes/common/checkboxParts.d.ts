...
export declare const Checkboxes: (<K extends string>(props: PropsWithChildren<CheckboxesProps<K>>) => import("react/jsx-runtime").JSX.Element) & {
    ...
    Card: import("tamagui").TamaguiComponent<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/core").RNTamaguiViewNonStyleProps, import("@tamagui/web").StackStyleBase, {}>, "unstyled"> & CardProps, import("tamagui").TamaguiElement, import("@tamagui/core").RNTamaguiViewNonStyleProps & CardProps, import("@tamagui/web").StackStyleBase, {}, import("@tamagui/web").StaticConfigPublic>;
};
export {};
