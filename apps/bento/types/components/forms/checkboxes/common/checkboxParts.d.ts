...
export declare const Checkboxes: (<K extends string>(
  ...
  > &
    ...
    > & {
      ...
      Item: (
        props: import('tamagui').GroupItemProps & {
          __scopeGroup?: import('tamagui').Scope
        }
      ) => any
    }
  /** FocusGroup is necessary for keyboard arrow navigation */
  FocusGroup: import('react').ForwardRefExoticComponent<
  ...
  Title: import('tamagui').TamaguiComponent<
    import('@tamagui/web').TamaDefer,
  ...
  Checkbox: import('react').ForwardRefExoticComponent<
    Omit<
      ...
      | 'sizeAdjust'
    > &
      import('tamagui').StackNonStyleProps &
      import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase> &
      import('@tamagui/web').WithShorthands<
        import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase>
      > &
  ...
  > &
    ...
    > & {
      ...
      Indicator: import('tamagui').TamaguiComponent<
        Omit<
          import('@tamagui/web').GetFinalProps<
            import('@tamagui/core').RNTamaguiViewNonStyleProps,
            import('@tamagui/web').StackStyleBase,
        ...
        import('@tamagui/web').StaticConfigPublic
      >
      Label: import('@tamagui/web').ReactComponentWithRef<
        import('tamagui').LabelProps,
        import('react-native').View | HTMLButtonElement
      >
    }
  Card: import('tamagui').TamaguiComponent<
    Omit<
      import('@tamagui/web').GetFinalProps<
        import('@tamagui/core').RNTamaguiViewNonStyleProps,
        import('@tamagui/web').StackStyleBase,
    ...
    > &
      CardProps,
    import('tamagui').TamaguiElement,
    import('@tamagui/core').RNTamaguiViewNonStyleProps & CardProps,
    import('@tamagui/web').StackStyleBase,
    {
      active?: boolean | undefined
    },
