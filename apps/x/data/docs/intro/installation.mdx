...
<Notice theme="green">
  Check out the [Tamagui TypeScript Plugin](https://github.com/nderscore/tamagui-typescript-plugin) for nice VSCode integration, and [VSCode Icons](https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons) which feature a `tamagui.config.ts` icon.
</Notice>
...
<Grid gap="$4">
  ...
  <LogoCard title="Metro" img="/logos/metro.svg" link="/docs/guides/metro" subtitle="Fast, scalable, and serverlessr javaScript bundler for react Native." colorOffset={3} />
