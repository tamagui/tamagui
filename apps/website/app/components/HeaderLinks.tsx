...
export const HeaderLinks = (props: HeaderProps) => {
  ...
  return (
    <>
      <Link passHref prefetch={false} href="/docs/intro/introduction">
        <HeadAnchor
      ...
      <Link passHref prefetch={false} href="/ui/intro/1.0.0">
        <HeadAnchor
          grid={forceShowAllLinks}
          $sm={{
            display: forceShowAllLinks ? 'flex' : 'none',
      ...
      {forceShowAllLinks && (
        <Link passHref prefetch={false} href="/community">
          <HeadAnchor grid>Community</HeadAnchor>
        </Link>
      )}

      {forceShowAllLinks && (
        <Link legacyBehavior={false} prefetch={false} href="/takeout">
      ...
      {forceShowAllLinks && (
        <Link legacyBehavior={false} prefetch={false} href="/bento">
          <HeadAnchor grid tag="span">
            Bento{' '}
      ...
      {!forceShowAllLinks && (
        <SlidingPopover>
          ...
          {/* <SlidingPopoverTrigger id="studio">
            <Link passHref prefetch={false} href="/studio">
              <HeadAnchor
                grid={forceShowAllLinks}
                $md={{
                  display: forceShowAllLinks ? 'flex' : 'none',
      ...
      {forceShowAllLinks && (
        <Link prefetch={false} href="https://github.com/sponsors/natew">
      ...
      {forceShowAllLinks && (
        <>
          ...
          <XStack fw="wrap" f={1} gap="$2" w="100%">
            {forceShowAllLinks && (
              <Link href="https://github.com/tamagui/tamagui">
            ...
            {forceShowAllLinks && (
              <Link href="https://www.figma.com/community/file/1326593766534421119/tamagui-v1-2-1">
                <HeadAnchor target="_blank" half grid={forceShowAllLinks}>
                  Figma{' '}
            ...
            <Link passHref prefetch={false} href="/blog">
            ...
            {userSwr.data?.userDetails && (
              <Link passHref prefetch={false} href="/account">
                <HeadAnchor half grid={forceShowAllLinks}>
                  Account
                </HeadAnchor>
              </Link>
            ...
            {!userSwr.data?.userDetails && (
              <Link passHref prefetch={false} href="/login">
                <HeadAnchor half grid={forceShowAllLinks}>
                  Login
                </HeadAnchor>
              </Link>
...
const CTAHeaderLink = ({
  ...
  return (
    <Link legacyBehavior={false} prefetch={false} href={href}>
      <Popover
        open={open}
        onOpenChange={(open) => {
          if (open) {
