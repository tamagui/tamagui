...
const HeroSubTitle = memo(() => {
  ...
  return (
    <Subtitle>
      ...
      ·{' '}
      <Link to="/docs/intro/why-a-compiler">
        <Tag theme="blue" onHoverIn={() => setHovered(1)} active={hovered === 1}>
          optimizing compiler
        </Tag>
      </Link>{' '}
      ·{' '}
      <Link to="/docs/components/stacks">
      ...
      >
        ...
        >
          <Link
            ...
            to="https://twitter.com/tamagui_js"
          >
          ...
          <Link target="_blank" legacyBehavior={false} to="https://discord.gg/4qh6tdcVDa">
