...
export declare const TextLink: React.ForwardRefExoticComponent<Pick<LinkProps, "target" | "href"> & Omit<import("tamagui").TextNonStyleProps, keyof import("@tamagui/web").TextStylePropsBase | "size" | "unstyled"> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
