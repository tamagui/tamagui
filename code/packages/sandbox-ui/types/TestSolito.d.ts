...
export declare const TextLink: React.ForwardRefExoticComponent<Pick<LinkProps, "target" | "href"> & Omit<import("tamagui").TextNonStyleProps, "size" | keyof import("@tamagui/web").TextStylePropsBase | "unstyled"> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
