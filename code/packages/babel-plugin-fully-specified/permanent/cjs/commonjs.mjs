          ...
          if (arg.type === "StringLiteral") {
            ...
            if (moduleSpecifier.startsWith(".") || moduleSpecifier.startsWith("/")) {
              ...
              if (!(0, import_node_path.extname)(moduleSpecifier)) {
                ...
                if (cjsExtension.startsWith(".native") && ((0, import_node_fs.existsSync)(`${resolvedPath}.ios.js`) || (0, import_node_fs.existsSync)(`${resolvedPath}.android.js`))) {
                  return;
                }
                if (isLocalDirectory(resolvedPath)) {
                  const indexBase = (0, import_node_path.resolve)(resolvedPath, "index");
                  if (cjsExtension.startsWith(".native") && ((0, import_node_fs.existsSync)(`${indexBase}.ios.js`) || (0, import_node_fs.existsSync)(`${indexBase}.android.js`))) {
                    return;
                  }
                ...
                if ((0, import_node_fs.existsSync)(resolvedPath + jsExtension) || (0, import_node_fs.existsSync)(resolvedPath + cjsExtension)) {
