          ...
          if (arg.type === "StringLiteral") {
            ...
            if (moduleSpecifier.startsWith(".") || moduleSpecifier.startsWith("/")) {
              ...
              if (!extname(moduleSpecifier)) {
                ...
                if (cjsExtension.startsWith(".native") && (existsSync(`${resolvedPath}.ios.js`) || existsSync(`${resolvedPath}.android.js`))) {
                  return;
                }
                if (isLocalDirectory(resolvedPath)) {
                  const indexBase = resolve(resolvedPath, "index");
                  if (cjsExtension.startsWith(".native") && (existsSync(`${indexBase}.ios.js`) || existsSync(`${indexBase}.android.js`))) {
                    return;
                  }
                ...
                if (existsSync(resolvedPath + jsExtension) || existsSync(resolvedPath + cjsExtension)) {
