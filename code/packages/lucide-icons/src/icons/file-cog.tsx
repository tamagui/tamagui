      ...
      const Icon = themed(memo(function FileCog(props: IconProps) {
  ...
  <Path d="M4.677 21.5a2 2 0 0 0 1.313.5H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v2.5" stroke={color}/>
  ...
  <_Circle cx="6" cy="14" r="3" stroke={color}/>
      ...
      export const FileCog: IconComponent = Icon
