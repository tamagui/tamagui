      ...
      const Icon = themed(memo(function Unplug(props: IconProps) {
  ...
  <Path d="M6.3 20.3a2.4 2.4 0 0 0 3.4 0L12 18l-6-6-2.3 2.3a2.4 2.4 0 0 0 0 3.4Z" stroke={color}/>
  <Path d="M7.5 13.5 10 11" stroke={color}/>
  <Path d="M10.5 16.5 13 14" stroke={color}/>
  <Path d="m12 6 6 6 2.3-2.3a2.4 2.4 0 0 0 0-3.4l-2.6-2.6a2.4 2.4 0 0 0-3.4 0Z" stroke={color}/>
</Svg>
        )
      }))
