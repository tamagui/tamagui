      ...
      const Icon = themed(memo(function WineOff(props: IconProps) {
  ...
  <Path d="M7.307 7.307A12.33 12.33 0 0 0 7 10a5 5 0 0 0 7.391 4.391M8.638 2.981C8.75 2.668 8.872 2.34 9 2h6c1.5 4 2 6 2 8 0 .407-.05.809-.145 1.198" stroke={color}/>
  <Line x1="2" x2="22" y1="2" y2="22" stroke={color}/>
      ...
      export const WineOff: IconComponent = Icon
