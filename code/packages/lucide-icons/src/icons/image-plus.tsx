      ...
      const Icon = themed(memo(function ImagePlus(props: IconProps) {
  ...
  <Path d="M21 11.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7.5" stroke={color}/>
  ...
  <_Circle cx="9" cy="9" r="2" stroke={color}/>
      ...
      export const ImagePlus: IconComponent = Icon
