      ...
      const Icon = themed(memo(function LandPlot(props: IconProps) {
  ...
  <Path d="m8 11.99-5.5 3.14a1 1 0 0 0 0 1.74l8.5 4.86a2 2 0 0 0 2 0l8.5-4.86a1 1 0 0 0 0-1.74L16 12" stroke={color}/>
  ...
  <Path d="M17.51 12.85 6.5 19.15" stroke={color}/>
      ...
      export const LandPlot: IconComponent = Icon
