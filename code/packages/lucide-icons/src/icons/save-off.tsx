      ...
      const Icon = themed(memo(function SaveOff(props: IconProps) {
  ...
  <Path d="M20.41 20.41A2 2 0 0 1 19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 .59-1.41" stroke={color}/>
  ...
  <Path d="M9 3h6.2a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V15" stroke={color}/>
      ...
      export const SaveOff: IconComponent = Icon
