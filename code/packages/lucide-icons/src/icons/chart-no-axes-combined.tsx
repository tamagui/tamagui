      ...
      const Icon = themed(memo(function ChartNoAxesCombined(props: IconProps) {
  ...
  <Path d="m22 3-8.646 8.646a.5.5 0 0 1-.708 0L9.354 8.354a.5.5 0 0 0-.707 0L2 15" stroke={color}/>
  ...
  <Path d="M8 14v7" stroke={color}/>
      ...
      export const ChartNoAxesCombined: IconComponent = Icon
