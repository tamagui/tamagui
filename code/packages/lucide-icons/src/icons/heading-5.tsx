      ...
      const Icon = themed(memo(function Heading5(props: IconProps) {
  ...
  <Path d="M17 17.7c.4.2.8.3 1.3.3 1.5 0 2.7-1.1 2.7-2.5S19.8 13 18.3 13H17" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const Heading5: IconComponent = Icon
