      ...
      const Icon = themed(memo(function RotateCwSquare(props: IconProps) {
  ...
  <Path d="M4 14v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const RotateCwSquare: IconComponent = Icon
