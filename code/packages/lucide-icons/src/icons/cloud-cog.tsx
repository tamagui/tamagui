      ...
      const Icon = themed(memo(function CloudCog(props: IconProps) {
  ...
  <Path d="M4.2 15.1a7 7 0 1 1 9.93-9.858A7 7 0 0 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.2" stroke={color}/>
