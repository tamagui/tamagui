      ...
      const Icon = themed(memo(function ScanEye(props: IconProps) {
  ...
  <Path d="M18.944 12.33a1 1 0 0 0 0-.66 7.5 7.5 0 0 0-13.888 0 1 1 0 0 0 0 .66 7.5 7.5 0 0 0 13.888 0" stroke={color}/>
</Svg>
        )
      }))
