      ...
      const Icon = themed(memo(function CalendarSearch(props: IconProps) {
  ...
  <Path d="M21 11.75V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7.25" stroke={color}/>
  ...
  <_Circle cx="18" cy="18" r="3" stroke={color}/>
      ...
      export const CalendarSearch: IconComponent = Icon
