      ...
      const Icon = themed(memo(function CookingPot(props: IconProps) {
  ...
  <Path d="m8.86 6.78-.45-1.81a2 2 0 0 1 1.45-2.43l1.94-.48a2 2 0 0 1 2.43 1.46l.45 1.8" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const CookingPot: IconComponent = Icon
