      ...
      const Icon = themed(memo(function HandMetal(props: IconProps) {
  ...
  <Path d="m7 15-1.76-1.76a2 2 0 0 0-2.83 2.82l3.6 3.6C7.5 21.14 9.2 22 12 22h2a8 8 0 0 0 8-8V7a2 2 0 1 0-4 0v5" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const HandMetal: IconComponent = Icon
