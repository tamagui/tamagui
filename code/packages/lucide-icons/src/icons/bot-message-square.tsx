      ...
      const Icon = themed(memo(function BotMessageSquare(props: IconProps) {
  ...
  <Path d="m8 18-4 4V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2Z" stroke={color}/>
  ...
  <Path d="M20 12h2" stroke={color}/>
      ...
      export const BotMessageSquare: IconComponent = Icon
