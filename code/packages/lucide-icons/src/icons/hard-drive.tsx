      ...
      const Icon = themed(memo(function HardDrive(props: IconProps) {
  ...
  <Path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" stroke={color}/>
  ...
  <Line x1="10" x2="10.01" y1="16" y2="16" stroke={color}/>
      ...
      export const HardDrive: IconComponent = Icon
