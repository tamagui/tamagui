      ...
      const Icon = themed(memo(function Projector(props: IconProps) {
  ...
  <Path d="M11.83 12H20a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h2.17" stroke={color}/>
  <Path d="M16 16h2" stroke={color}/>
      ...
      export const Projector: IconComponent = Icon
