      ...
      const Icon = themed(memo(function Skull(props: IconProps) {
  ...
  <Path d="M15 22a1 1 0 0 0 1-1v-1a2 2 0 0 0 1.56-3.25 8 8 0 1 0-11.12 0A2 2 0 0 0 8 20v1a1 1 0 0 0 1 1z" stroke={color}/>
  ...
  <_Circle cx="9" cy="12" r="1" stroke={color}/>
      ...
      export const Skull: IconComponent = Icon
