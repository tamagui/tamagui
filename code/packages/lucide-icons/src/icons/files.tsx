      ...
      const Icon = themed(memo(function Files(props: IconProps) {
  ...
  <Path d="M9 18a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h7l4 4v10a2 2 0 0 1-2 2Z" stroke={color}/>
  <Path d="M3 7.6v12.8A1.6 1.6 0 0 0 4.6 22h9.8" stroke={color}/>
      ...
      export const Files: IconComponent = Icon
