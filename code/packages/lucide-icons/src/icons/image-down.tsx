      ...
      const Icon = themed(memo(function ImageDown(props: IconProps) {
  ...
  <Path d="M10.3 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10l-3.1-3.1a2 2 0 0 0-2.814.014L6 21" stroke={color}/>
  ...
  <_Circle cx="9" cy="9" r="2" stroke={color}/>
      ...
      export const ImageDown: IconComponent = Icon
