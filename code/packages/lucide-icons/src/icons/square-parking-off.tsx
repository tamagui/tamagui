      ...
      const Icon = themed(memo(function SquareParkingOff(props: IconProps) {
  ...
  <Path d="M3.6 3.6A2 2 0 0 1 5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-.59 1.41" stroke={color}/>
  ...
  <Path d="M9 17v-2.3" stroke={color}/>
      ...
      export const SquareParkingOff: IconComponent = Icon
