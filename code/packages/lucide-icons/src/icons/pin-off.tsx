      ...
      const Icon = themed(memo(function PinOff(props: IconProps) {
  ...
  <Path d="M9 9v1.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h11" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const PinOff: IconComponent = Icon
