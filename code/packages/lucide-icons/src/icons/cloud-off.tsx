      ...
      const Icon = themed(memo(function CloudOff(props: IconProps) {
  ...
  <Path d="M21.532 16.5A4.5 4.5 0 0 0 17.5 10h-1.79A7.008 7.008 0 0 0 10 5.07" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const CloudOff: IconComponent = Icon
