      ...
      const Icon = themed(memo(function BeerOff(props: IconProps) {
  ...
  <Path d="M7.536 7.535C6.766 7.649 6.154 8 5.5 8a2.5 2.5 0 0 1-1.768-4.268" stroke={color}/>
  <Path d="M8.727 3.204C9.306 2.767 9.885 2 11 2c1.56 0 2 1.5 3 1.5s1.72-.5 2.5-.5a1 1 0 1 1 0 5c-.78 0-1.5-.5-2.5-.5a3.149 3.149 0 0 0-.842.12" stroke={color}/>
  <Path d="M9 14.6V18" stroke={color}/>
      ...
      export const BeerOff: IconComponent = Icon
