      ...
      const Icon = themed(memo(function Hamburger(props: IconProps) {
  ...
  <Path d="M5 16a2 2 0 0 0-2 2 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 2 2 0 0 0-2-2q0 0 0 0" stroke={color}/>
  <Path d="m6.67 12 6.13 4.6a2 2 0 0 0 2.8-.4l3.15-4.2" stroke={color}/>
      ...
      export const Hamburger: IconComponent = Icon
