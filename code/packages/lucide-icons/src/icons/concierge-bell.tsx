      ...
      const Icon = themed(memo(function ConciergeBell(props: IconProps) {
  ...
  <Path d="M3 20a1 1 0 0 1-1-1v-1a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1a1 1 0 0 1-1 1Z" stroke={color}/>
  ...
  <Path d="M10 4h4" stroke={color}/>
      ...
      export const ConciergeBell: IconComponent = Icon
