      ...
      const Icon = themed(memo(function Amphora(props: IconProps) {
  ...
  <Path d="M10 2v5.632c0 .424-.272.795-.653.982A6 6 0 0 0 6 14c.006 4 3 7 5 8" stroke={color}/>
  <Path d="M10 5H8a2 2 0 0 0 0 4h.68" stroke={color}/>
  <Path d="M14 2v5.632c0 .424.272.795.652.982A6 6 0 0 1 18 14c0 4-3 7-5 8" stroke={color}/>
  ...
  <Path d="M9 2h6" stroke={color}/>
      ...
      export const Amphora: IconComponent = Icon
