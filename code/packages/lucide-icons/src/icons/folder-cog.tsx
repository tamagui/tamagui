      ...
      const Icon = themed(memo(function FolderCog(props: IconProps) {
  ...
  <Path d="M10.3 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.98a2 2 0 0 1 1.69.9l.66 1.2A2 2 0 0 0 12 6h8a2 2 0 0 1 2 2v3.3" stroke={color}/>
  ...
  <_Circle cx="18" cy="18" r="3" stroke={color}/>
      ...
      export const FolderCog: IconComponent = Icon
