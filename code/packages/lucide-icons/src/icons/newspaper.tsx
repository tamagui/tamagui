      ...
      const Icon = themed(memo(function Newspaper(props: IconProps) {
  ...
  <Path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2" stroke={color}/>
