      ...
      const Icon = themed(memo(function MilkOff(props: IconProps) {
  ...
  <Path d="M9 2v1.343M15 2v2.789a4 4 0 0 0 .672 2.219l.656.984a4 4 0 0 1 .672 2.22v1.131M7.8 7.8l-.128.192A4 4 0 0 0 7 10.212V20a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-3" stroke={color}/>
  ...
  <Line x1="2" x2="22" y1="2" y2="22" stroke={color}/>
      ...
      export const MilkOff: IconComponent = Icon
