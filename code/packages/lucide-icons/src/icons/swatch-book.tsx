      ...
      const Icon = themed(memo(function SwatchBook(props: IconProps) {
  ...
  <Path d="m11 8 2.3-2.3a2.4 2.4 0 0 1 3.404.004L18.6 7.6a2.4 2.4 0 0 1 .026 3.434L9.9 19.8" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const SwatchBook: IconComponent = Icon
