      ...
      const Icon = themed(memo(function ScreenShareOff(props: IconProps) {
  ...
  <Path d="M13 3H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-3" stroke={color}/>
  ...
  <Path d="m17 3 5 5" stroke={color}/>
      ...
      export const ScreenShareOff: IconComponent = Icon
