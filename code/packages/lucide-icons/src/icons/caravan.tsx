      ...
      const Icon = themed(memo(function Caravan(props: IconProps) {
  ...
  <Path d="M22 17v1a1 1 0 0 1-1 1H10v-9a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v9" stroke={color}/>
  <_Circle cx="8" cy="19" r="2" stroke={color}/>
      ...
      export const Caravan: IconComponent = Icon
