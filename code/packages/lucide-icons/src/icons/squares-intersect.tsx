      ...
      const Icon = themed(memo(function SquaresIntersect(props: IconProps) {
  ...
  <Path d="M8 10a2 2 0 0 1 2-2h5a1 1 0 0 1 1 1v5a2 2 0 0 1-2 2H9a1 1 0 0 1-1-1z" stroke={color}/>
