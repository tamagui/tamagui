      ...
      const Icon = themed(memo(function MemoryStick(props: IconProps) {
  ...
  <Path d="M2 7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1.1a2 2 0 0 0 0 3.837V17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-5.1a2 2 0 0 0 0-3.837Z" stroke={color}/>
</Svg>
        )
      }))
