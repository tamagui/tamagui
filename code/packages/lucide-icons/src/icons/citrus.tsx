      ...
      const Icon = themed(memo(function Citrus(props: IconProps) {
  ...
  <Path d="M21.66 17.67a1.08 1.08 0 0 1-.04 1.6A12 12 0 0 1 4.73 2.38a1.1 1.1 0 0 1 1.61-.04z" stroke={color}/>
  ...
  <Path d="M14 17.85V10H6.15" stroke={color}/>
      ...
      export const Citrus: IconComponent = Icon
