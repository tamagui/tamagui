      ...
      const Icon = themed(memo(function FileArchive(props: IconProps) {
  ...
  <Path d="M15.5 22H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v16a2 2 0 0 0 .274 1.01" stroke={color}/>
  <_Circle cx="10" cy="20" r="2" stroke={color}/>
      ...
      export const FileArchive: IconComponent = Icon
