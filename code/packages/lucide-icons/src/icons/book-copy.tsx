      ...
      const Icon = themed(memo(function BookCopy(props: IconProps) {
  ...
  <Path d="M22 18H11a2 2 0 1 0 0 4h10.5a.5.5 0 0 0 .5-.5v-15a.5.5 0 0 0-.5-.5H11a2 2 0 0 0-2 2v12" stroke={color}/>
  <Path d="M5 14H4a2 2 0 1 0 0 4h1" stroke={color}/>
      ...
      export const BookCopy: IconComponent = Icon
