      ...
      const Icon = themed(memo(function EarthLock(props: IconProps) {
  ...
  <Path d="M11 21.95V18a2 2 0 0 0-2-2 2 2 0 0 1-2-2v-1a2 2 0 0 0-2-2H2.05" stroke={color}/>
  ...
  <Rect width="8" height="5" x="14" y="6" rx="1" stroke={color}/>
      ...
      export const EarthLock: IconComponent = Icon
