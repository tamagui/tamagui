      ...
      const Icon = themed(memo(function Luggage(props: IconProps) {
  ...
  <Path d="M6 20a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2" stroke={color}/>
  ...
  <_Circle cx="8" cy="20" r="2" stroke={color}/>
      ...
      export const Luggage: IconComponent = Icon
