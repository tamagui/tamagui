      ...
      const Icon = themed(memo(function UmbrellaOff(props: IconProps) {
  ...
  <Path d="M15.5 21a1.85 1.85 0 0 1-3.5-1v-8H2a10 10 0 0 1 3.428-6.575" stroke={color}/>
  ...
  <Path d="m2 2 20 20" stroke={color}/>
      ...
      export const UmbrellaOff: IconComponent = Icon
