      ...
      const Icon = themed(memo(function Webhook(props: IconProps) {
  ...
  <Path d="M18 16.98h-5.99c-1.1 0-1.95.94-2.48 1.9A4 4 0 0 1 2 17c.01-.7.2-1.4.57-2" stroke={color}/>
  <Path d="m6 17 3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06" stroke={color}/>
