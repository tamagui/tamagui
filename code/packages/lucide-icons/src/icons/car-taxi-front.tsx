      ...
      const Icon = themed(memo(function CarTaxiFront(props: IconProps) {
  ...
  <Path d="m21 8-2 2-1.5-3.7A2 2 0 0 0 15.646 5H8.4a2 2 0 0 0-1.903 1.257L5 10 3 8" stroke={color}/>
  ...
  <Path d="M19 18v2" stroke={color}/>
      ...
      export const CarTaxiFront: IconComponent = Icon
