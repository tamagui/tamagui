      ...
      const Icon = themed(memo(function CalendarX2(props: IconProps) {
  ...
  <Path d="M21 13V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8" stroke={color}/>
  ...
  <Path d="m17 17 5 5" stroke={color}/>
      ...
      export const CalendarX2: IconComponent = Icon
