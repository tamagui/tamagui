      ...
      const Icon = themed(memo(function HandCoins(props: IconProps) {
  ...
  <Path d="m7 21 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9" stroke={color}/>
  ...
  <_Circle cx="6" cy="5" r="3" stroke={color}/>
      ...
      export const HandCoins: IconComponent = Icon
