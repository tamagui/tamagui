      ...
      const Icon = themed(memo(function Save(props: IconProps) {
  ...
  <Path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z" stroke={color}/>
  ...
  <Path d="M7 3v4a1 1 0 0 0 1 1h7" stroke={color}/>
      ...
      export const Save: IconComponent = Icon
