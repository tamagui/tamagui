      ...
      const Icon = themed(memo(function Tractor(props: IconProps) {
  ...
  <Path d="m10 11 11 .9a1 1 0 0 1 .8 1.1l-.665 4.158a1 1 0 0 1-.988.842H20" stroke={color}/>
  ...
  <_Circle cx="7" cy="15" r="5" stroke={color}/>
      ...
      export const Tractor: IconComponent = Icon
