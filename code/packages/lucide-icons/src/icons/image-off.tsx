      ...
      const Icon = themed(memo(function ImageOff(props: IconProps) {
  ...
  <Path d="M3.59 3.59A1.99 1.99 0 0 0 3 5v14a2 2 0 0 0 2 2h14c.55 0 1.052-.22 1.41-.59" stroke={color}/>
  <Path d="M21 15V5a2 2 0 0 0-2-2H9" stroke={color}/>
      ...
      export const ImageOff: IconComponent = Icon
