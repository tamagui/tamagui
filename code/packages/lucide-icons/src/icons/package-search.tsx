      ...
      const Icon = themed(memo(function PackageSearch(props: IconProps) {
  ...
  <Path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14" stroke={color}/>
  ...
  <Path d="M20.27 17.27 22 19" stroke={color}/>
      ...
      export const PackageSearch: IconComponent = Icon
