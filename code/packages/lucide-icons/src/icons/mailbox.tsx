      ...
      const Icon = themed(memo(function Mailbox(props: IconProps) {
  ...
  <Path d="M22 17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.5C2 7 4 5 6.5 5H18c2.2 0 4 1.8 4 4v8Z" stroke={color}/>
