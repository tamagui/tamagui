      ...
      const Icon = themed(memo(function BellPlus(props: IconProps) {
  ...
  <Path d="M20.002 14.464a9 9 0 0 0 .738.863A1 1 0 0 1 20 17H4a1 1 0 0 1-.74-1.673C4.59 13.956 6 12.499 6 8a6 6 0 0 1 8.75-5.332" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const BellPlus: IconComponent = Icon
