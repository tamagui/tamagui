      ...
      const Icon = themed(memo(function Bug(props: IconProps) {
  ...
  <Path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6" stroke={color}/>
  ...
  <Path d="M17.2 17c2.1.1 3.8 1.9 3.8 4" stroke={color}/>
      ...
      export const Bug: IconComponent = Icon
