      ...
      const Icon = themed(memo(function FileSearch(props: IconProps) {
  ...
  <Path d="M4.268 21a2 2 0 0 0 1.727 1H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3" stroke={color}/>
  ...
  <_Circle cx="5" cy="14" r="3" stroke={color}/>
      ...
      export const FileSearch: IconComponent = Icon
