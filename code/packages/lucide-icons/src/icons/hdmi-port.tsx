      ...
      const Icon = themed(memo(function HdmiPort(props: IconProps) {
  ...
  <Path d="M22 9a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h1l2 2h12l2-2h1a1 1 0 0 0 1-1Z" stroke={color}/>
