      ...
      const Icon = themed(memo(function MapPinOff(props: IconProps) {
  ...
  <Path d="M17.072 17.072c-1.634 2.17-3.527 3.912-4.471 4.727a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 1.432-4.568" stroke={color}/>
