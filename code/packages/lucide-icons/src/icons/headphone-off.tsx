      ...
      const Icon = themed(memo(function HeadphoneOff(props: IconProps) {
  ...
  <Path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 2.636-6.364" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const HeadphoneOff: IconComponent = Icon
