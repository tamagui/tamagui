      ...
      const Icon = themed(memo(function CalendarFold(props: IconProps) {
  ...
  <Path d="M21 17V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11Z" stroke={color}/>
  ...
  <Path d="M15 22v-4a2 2 0 0 1 2-2h4" stroke={color}/>
      ...
      export const CalendarFold: IconComponent = Icon
