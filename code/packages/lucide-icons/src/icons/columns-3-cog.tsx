      ...
      const Icon = themed(memo(function Columns3Cog(props: IconProps) {
  ...
  <Path d="M10.5 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5.5" stroke={color}/>
  ...
  <_Circle cx="18" cy="18" r="3" stroke={color}/>
      ...
      export const Columns3Cog: IconComponent = Icon
