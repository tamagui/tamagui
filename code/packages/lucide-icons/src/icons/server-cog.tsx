      ...
      const Icon = themed(memo(function ServerCog(props: IconProps) {
  ...
  <Path d="M4.5 10H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-.5" stroke={color}/>
  <Path d="M4.5 14H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-.5" stroke={color}/>
  ...
  <Path d="m9.228 13.148-.923.383" stroke={color}/>
      ...
      export const ServerCog: IconComponent = Icon
