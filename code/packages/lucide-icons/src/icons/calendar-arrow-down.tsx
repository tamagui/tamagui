      ...
      const Icon = themed(memo(function CalendarArrowDown(props: IconProps) {
  ...
  <Path d="M21 11.354V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7.343" stroke={color}/>
  ...
  <Path d="M8 2v4" stroke={color}/>
      ...
      export const CalendarArrowDown: IconComponent = Icon
