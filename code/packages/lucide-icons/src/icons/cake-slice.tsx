      ...
      const Icon = themed(memo(function CakeSlice(props: IconProps) {
  ...
  <Path d="M7.2 7.9 3 11v9c0 .6.4 1 1 1h16c.6 0 1-.4 1-1v-9c0-2-3-6-7-8l-3.6 2.6" stroke={color}/>
  ...
  <Path d="M16 17H3" stroke={color}/>
      ...
      export const CakeSlice: IconComponent = Icon
