      ...
      const Icon = themed(memo(function NutOff(props: IconProps) {
  ...
  <Line x1="2" x2="22" y1="2" y2="22" stroke={color}/>
      ...
      export const NutOff: IconComponent = Icon
