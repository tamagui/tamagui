      ...
      const Icon = themed(memo(function TowerControl(props: IconProps) {
  ...
  <Path d="M18.2 12.27 20 6H4l1.8 6.27a1 1 0 0 0 .95.73h10.5a1 1 0 0 0 .96-.73Z" stroke={color}/>
  ...
  <Path d="M13 2h-2" stroke={color}/>
      ...
      export const TowerControl: IconComponent = Icon
