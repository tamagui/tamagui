      ...
      const Icon = themed(memo(function VolumeOff(props: IconProps) {
  ...
  <Path d="m7 7-.587.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298V11" stroke={color}/>
  <Path d="M9.828 4.172A.686.686 0 0 1 11 4.657v.686" stroke={color}/>
      ...
      export const VolumeOff: IconComponent = Icon
