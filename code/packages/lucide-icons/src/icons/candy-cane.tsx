      ...
      const Icon = themed(memo(function CandyCane(props: IconProps) {
  ...
  <Path d="M5.7 21a2 2 0 0 1-3.5-2l8.6-14a6 6 0 0 1 10.4 6 2 2 0 1 1-3.464-2 2 2 0 1 0-3.464-2Z" stroke={color}/>
  ...
  <Path d="M4.9 14.7 7 18.9" stroke={color}/>
      ...
      export const CandyCane: IconComponent = Icon
