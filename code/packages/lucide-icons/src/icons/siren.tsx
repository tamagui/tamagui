      ...
      const Icon = themed(memo(function Siren(props: IconProps) {
  ...
  <Path d="M5 21a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-1a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2z" stroke={color}/>
  ...
  <Path d="M12 12v6" stroke={color}/>
      ...
      export const Siren: IconComponent = Icon
