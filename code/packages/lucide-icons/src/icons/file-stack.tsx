      ...
      const Icon = themed(memo(function FileStack(props: IconProps) {
  ...
  <Path d="M21 6v6.5c0 .8-.7 1.5-1.5 1.5h-7c-.8 0-1.5-.7-1.5-1.5v-9c0-.8.7-1.5 1.5-1.5H17Z" stroke={color}/>
  ...
  <Path d="M3 12v8.8c0 .3.2.6.4.8.2.2.5.4.8.4H11" stroke={color}/>
      ...
      export const FileStack: IconComponent = Icon
