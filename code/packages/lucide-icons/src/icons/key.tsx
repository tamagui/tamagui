      ...
      const Icon = themed(memo(function Key(props: IconProps) {
  ...
  <Path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4" stroke={color}/>
  ...
  <_Circle cx="7.5" cy="15.5" r="5.5" stroke={color}/>
      ...
      export const Key: IconComponent = Icon
