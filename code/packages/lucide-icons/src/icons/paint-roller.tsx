      ...
      const Icon = themed(memo(function PaintRoller(props: IconProps) {
  ...
  <Path d="M10 16v-2a2 2 0 0 1 2-2h8a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" stroke={color}/>
  <Rect width="4" height="6" x="8" y="16" rx="1" stroke={color}/>
      ...
      export const PaintRoller: IconComponent = Icon
