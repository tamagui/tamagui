      ...
      const Icon = themed(memo(function TrainFront(props: IconProps) {
  ...
  <Path d="M9 19c-2.8 0-5-2.2-5-5v-4a8 8 0 0 1 16 0v4c0 2.8-2.2 5-5 5Z" stroke={color}/>
  ...
  <Path d="m16 19 2 3" stroke={color}/>
      ...
      export const TrainFront: IconComponent = Icon
