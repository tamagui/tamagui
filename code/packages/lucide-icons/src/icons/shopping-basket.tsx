      ...
      const Icon = themed(memo(function ShoppingBasket(props: IconProps) {
  ...
  <Path d="m3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8a2 2 0 0 0 2-1.6l1.7-7.4" stroke={color}/>
  ...
  <Path d="m9 11 1 9" stroke={color}/>
      ...
      export const ShoppingBasket: IconComponent = Icon
