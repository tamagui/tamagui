      ...
      const Icon = themed(memo(function HeartHandshake(props: IconProps) {
  ...
  <Path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08c.82.82 2.13.85 3 .07l2.07-1.9a2.82 2.82 0 0 1 3.79 0l2.96 2.66" stroke={color}/>
  ...
  <Path d="m15 18-2-2" stroke={color}/>
      ...
      export const HeartHandshake: IconComponent = Icon
