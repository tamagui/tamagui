      ...
      const Icon = themed(memo(function ZapOff(props: IconProps) {
  ...
  <Path d="M16.273 16.273 10.88 21.83a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14H4a1 1 0 0 1-.78-1.63l4.507-4.643" stroke={color}/>
