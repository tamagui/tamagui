      ...
      const Icon = themed(memo(function Cast(props: IconProps) {
  ...
  <Path d="M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6" stroke={color}/>
  ...
  <Line x1="2" x2="2.01" y1="20" y2="20" stroke={color}/>
      ...
      export const Cast: IconComponent = Icon
