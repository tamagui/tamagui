      ...
      const Icon = themed(memo(function FileChartPie(props: IconProps) {
  ...
  <Path d="M9 16a1 1 0 0 1-1-1v-4c0-.552.45-1.008.995-.917a6 6 0 0 1 4.922 4.922c.091.544-.365.995-.917.995z" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const FileChartPie: IconComponent = Icon
