      ...
      const Icon = themed(memo(function DatabaseBackup(props: IconProps) {
  ...
  <Path d="M13 20a5 5 0 0 0 9-3 4.5 4.5 0 0 0-4.5-4.5c-1.33 0-2.54.54-3.41 1.41L12 16" stroke={color}/>
</Svg>
        )
      }))
