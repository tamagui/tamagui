      ...
      const Icon = themed(memo(function CalendarSync(props: IconProps) {
  ...
  <Path d="M21 8.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h4.3" stroke={color}/>
  ...
  <Path d="M8 2v4" stroke={color}/>
      ...
      export const CalendarSync: IconComponent = Icon
