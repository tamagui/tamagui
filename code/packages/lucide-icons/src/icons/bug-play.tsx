      ...
      const Icon = themed(memo(function BugPlay(props: IconProps) {
  ...
  <Path d="M12.765 21.522a.5.5 0 0 1-.765-.424v-8.196a.5.5 0 0 1 .765-.424l5.878 3.674a1 1 0 0 1 0 1.696z" stroke={color}/>
  <Path d="M14.12 3.88 16 2" stroke={color}/>
  <Path d="M18 11a4 4 0 0 0-4-4h-4a4 4 0 0 0-4 4v3a6.1 6.1 0 0 0 2 4.5" stroke={color}/>
