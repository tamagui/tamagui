      ...
      const Icon = themed(memo(function GlobeLock(props: IconProps) {
  ...
  <Path d="M15.686 15A14.5 14.5 0 0 1 12 22a14.5 14.5 0 0 1 0-20 10 10 0 1 0 9.542 13" stroke={color}/>
