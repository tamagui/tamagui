      ...
      const Icon = themed(memo(function CloudMoonRain(props: IconProps) {
  ...
  <Path d="M10.188 8.5A6 6 0 0 1 16 4a1 1 0 0 0 6 6 6 6 0 0 1-3 5.197" stroke={color}/>
  ...
  <Path d="M7 19v2" stroke={color}/>
      ...
      export const CloudMoonRain: IconComponent = Icon
