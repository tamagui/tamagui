      ...
      const Icon = themed(memo(function ScanHeart(props: IconProps) {
  ...
  <Path d="M11.246 16.657a1 1 0 0 0 1.508 0l3.57-4.101A2.75 2.75 0 1 0 12 9.168a2.75 2.75 0 1 0-4.324 3.388z" stroke={color}/>
  ...
  <Path d="M7 21H5a2 2 0 0 1-2-2v-2" stroke={color}/>
      ...
      export const ScanHeart: IconComponent = Icon
