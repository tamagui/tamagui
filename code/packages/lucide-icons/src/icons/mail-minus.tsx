      ...
      const Icon = themed(memo(function MailMinus(props: IconProps) {
  ...
  <Path d="M22 15V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8" stroke={color}/>
  ...
  <Path d="M16 19h6" stroke={color}/>
      ...
      export const MailMinus: IconComponent = Icon
