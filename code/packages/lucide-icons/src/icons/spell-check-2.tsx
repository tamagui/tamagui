      ...
      const Icon = themed(memo(function SpellCheck2(props: IconProps) {
  ...
  <Path d="M4 21c1.1 0 1.1-1 2.3-1s1.1 1 2.3 1c1.1 0 1.1-1 2.3-1 1.1 0 1.1 1 2.3 1 1.1 0 1.1-1 2.3-1 1.1 0 1.1 1 2.3 1 1.1 0 1.1-1 2.3-1" stroke={color}/>
</Svg>
        )
      }))
