      ...
      const Icon = themed(memo(function Watch(props: IconProps) {
  ...
  <Path d="m16.13 7.66-.81-4.05a2 2 0 0 0-2-1.61h-2.68a2 2 0 0 0-2 1.61l-.78 4.05" stroke={color}/>
  <Path d="m7.88 16.36.8 4a2 2 0 0 0 2 1.61h2.72a2 2 0 0 0 2-1.61l.81-4.05" stroke={color}/>
</Svg>
        )
      }))
