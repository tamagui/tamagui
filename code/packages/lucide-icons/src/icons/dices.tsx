      ...
      const Icon = themed(memo(function Dices(props: IconProps) {
  ...
  <Path d="m17.92 14 3.5-3.5a2.24 2.24 0 0 0 0-3l-5-4.92a2.24 2.24 0 0 0-3 0L10 6" stroke={color}/>
  ...
  <Path d="M18 9h.01" stroke={color}/>
      ...
      export const Dices: IconComponent = Icon
