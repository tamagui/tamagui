      ...
      const Icon = themed(memo(function FileBadge2(props: IconProps) {
  ...
  <Path d="m13.69 12.479 1.29 4.88a.5.5 0 0 1-.697.591l-1.844-.849a1 1 0 0 0-.88.001l-1.846.85a.5.5 0 0 1-.693-.593l1.29-4.88" stroke={color}/>
  ...
  <_Circle cx="12" cy="10" r="3" stroke={color}/>
      ...
      export const FileBadge2: IconComponent = Icon
