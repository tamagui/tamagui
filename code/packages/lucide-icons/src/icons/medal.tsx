      ...
      const Icon = themed(memo(function Medal(props: IconProps) {
  ...
  <Path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.79 15" stroke={color}/>
  ...
  <Path d="M12 18v-2h-.5" stroke={color}/>
      ...
      export const Medal: IconComponent = Icon
