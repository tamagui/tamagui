      ...
      const Icon = themed(memo(function MailSearch(props: IconProps) {
  ...
  <Path d="M22 12.5V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h7.5" stroke={color}/>
  ...
  <Path d="m22 22-1.5-1.5" stroke={color}/>
      ...
      export const MailSearch: IconComponent = Icon
