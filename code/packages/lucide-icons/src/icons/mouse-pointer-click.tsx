      ...
      const Icon = themed(memo(function MousePointerClick(props: IconProps) {
  ...
  <Path d="M9.037 9.69a.498.498 0 0 1 .653-.653l11 4.5a.5.5 0 0 1-.074.949l-4.349 1.041a1 1 0 0 0-.74.739l-1.04 4.35a.5.5 0 0 1-.95.074z" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const MousePointerClick: IconComponent = Icon
