      ...
      const Icon = themed(memo(function BookUp2(props: IconProps) {
  ...
  <Path d="M18 2h1a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20" stroke={color}/>
  ...
  <Path d="m9 5 3-3 3 3" stroke={color}/>
      ...
      export const BookUp2: IconComponent = Icon
