      ...
      const Icon = themed(memo(function FileSymlink(props: IconProps) {
  ...
  <Path d="M4 11V4a2 2 0 0 1 2-2h9l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h7" stroke={color}/>
</Svg>
        )
      }))
      ...
      export const FileSymlink: IconComponent = Icon
