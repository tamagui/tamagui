      ...
      const Icon = themed(memo(function School(props: IconProps) {
  ...
  <Path d="m18 10 3.447 1.724a1 1 0 0 1 .553.894V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-7.382a1 1 0 0 1 .553-.894L6 10" stroke={color}/>
  ...
  <_Circle cx="12" cy="9" r="2" stroke={color}/>
      ...
      export const School: IconComponent = Icon
