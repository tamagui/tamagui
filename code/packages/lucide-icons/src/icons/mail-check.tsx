      ...
      const Icon = themed(memo(function MailCheck(props: IconProps) {
  ...
  <Path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8" stroke={color}/>
  ...
  <Path d="m16 19 2 2 4-4" stroke={color}/>
      ...
      export const MailCheck: IconComponent = Icon
