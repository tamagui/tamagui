      ...
      const Icon = themed(memo(function BanknoteArrowDown(props: IconProps) {
  ...
  <Path d="M12 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5" stroke={color}/>
  ...
  <_Circle cx="12" cy="12" r="2" stroke={color}/>
      ...
      export const BanknoteArrowDown: IconComponent = Icon
