      ...
      const Icon = themed(memo(function CalendarPlus(props: IconProps) {
  ...
  <Path d="M21 12.598V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8.5" stroke={color}/>
  ...
  <Path d="M8 2v4" stroke={color}/>
      ...
      export const CalendarPlus: IconComponent = Icon
