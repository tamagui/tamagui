      ...
      const Icon = themed(memo(function AirVent(props: IconProps) {
  ...
  <Path d="M6 12H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" stroke={color}/>
  ...
  <Path d="M6.6 15.572A2 2 0 1 0 10 17v-5" stroke={color}/>
      ...
      export const AirVent: IconComponent = Icon
