      ...
      const Icon = themed(memo(function ClipboardCopy(props: IconProps) {
  ...
  <Path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" stroke={color}/>
  ...
  <Path d="m15 10-4 4 4 4" stroke={color}/>
      ...
      export const ClipboardCopy: IconComponent = Icon
