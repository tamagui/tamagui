      ...
      const Icon = themed(memo(function Flower(props: IconProps) {
  ...
  <Path d="M12 16.5A4.5 4.5 0 1 1 7.5 12 4.5 4.5 0 1 1 12 7.5a4.5 4.5 0 1 1 4.5 4.5 4.5 4.5 0 1 1-4.5 4.5" stroke={color}/>
  ...
  <Path d="M14.12 14.12 16 16" stroke={color}/>
      ...
      export const Flower: IconComponent = Icon
