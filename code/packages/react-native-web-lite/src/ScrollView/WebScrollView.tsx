...
// self-contained copy of @tamagui/scroll-view's WebScrollView built on lite's
// own View: lite IS the react-native substitute in native-target bundles, so
// it must not import tamagui packages (their native builds import
// react-native = lite, a require cycle that leaves exports undefined).
// keep in sync with code/ui/scroll-view/src/WebScrollView.tsx.
const View = LiteView as any
