...
import { Theme } from '@tamagui/style'
import { createThemeUpdateState } from '@tamagui/web/theme-update'
...
export function Island(props) {
  ...
  for (let index = layers.length - 1; index >= 0; index--) {
    node = React.createElement(
      Theme,
      {
        _themeUpdate: createThemeUpdateState(
          layers[index].inlineValues,
          layers[index].inlineClassName
        ),
        forceClassName: true,
      },
      node
