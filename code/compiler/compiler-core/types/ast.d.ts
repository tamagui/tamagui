...
export declare function findAstNode(root: AstNode, predicate: (node: AstNode, parent: AstNode | null, key: string | null) => boolean, span?: Pick<AstNode, 'start' | 'end'>): AstNode | null;
