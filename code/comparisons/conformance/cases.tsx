...
const box =
  (cls: string) =>
  ({ Box }: Leaf) => <Box id="cfm-root" className={cls} />
...
export const cases: ConformanceCase[] = [
  ...
  { name: 'size-max-w', render: box('w-96 max-w-24 h-8 bg-amber-500') },
  {
    name: 'size-full',
    render: ({ Box }) => (
      <Box className="w-64 h-16 bg-slate-200">
        <Box id="cfm-root" className="w-full h-8 bg-sky-500" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box className="w-64 h-16 bg-slate-200">
        <Box id="cfm-root" className="w-1/2 h-8 bg-rose-500" />
      </Box>
    ),
  },
  ...
  },
  {
    name: 'padding-xy',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-violet-500 px-6 py-2">
        <Box className="w-12 h-6 bg-white" />
      </Box>
    ),
  },
  {
    name: 'padding-t',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 bg-emerald-500 pt-8">
        <Box className="w-full h-6 bg-white" />
      </Box>
    ),
  },
  ...
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 flex flex-col gap-3 p-3 bg-slate-100">
        <Box className="w-10 h-6 bg-red-500" />
        <Box className="w-10 h-6 bg-green-500" />
      </Box>
    ),
  },
  ...
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row justify-between w-40 h-10 bg-slate-100">
        <Box className="w-8 h-8 bg-red-500" />
        <Box className="w-8 h-8 bg-green-500" />
      </Box>
    ),
  },
  {
    name: 'items-justify-center',
    render: ({ Box }) => (
      <Box
        id="cfm-root"
        className="flex flex-row items-center justify-center w-40 h-20 bg-slate-100"
      >
  ...
  // ── opacity ───────────────────────────────────────────────────────────────
  {
    name: 'opacity-half',
    render: ({ Box }) => (
      <Box className="w-16 h-16 bg-white">
        <Box id="cfm-root" className="w-16 h-16 bg-black opacity-50" />
      </Box>
    ),
  },
  ...
  // ── opacity levels ────────────────────────────────────────────────────────────
  {
    ...
    render: ({ Box }) => (
      <Box className="w-16 h-16 bg-white">
        <Box id="cfm-root" className="w-16 h-16 bg-blue-600 opacity-25" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box className="w-16 h-16 bg-white">
        <Box id="cfm-root" className="w-16 h-16 bg-blue-600 opacity-75" />
      </Box>
    ),
  },
  ...
  // ── single-side padding (colored box, dark inner for a clean diff) ──────────────
  {
    name: 'pad-left',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-sky-500 pl-8">
        <Box className="w-8 h-12 bg-slate-900" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 bg-emerald-500 pt-8">
        <Box className="w-12 h-8 bg-slate-900" />
      </Box>
    ),
  },
  ...
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row justify-around w-40 h-10 bg-slate-200">
        <Box className="w-6 h-8 bg-red-600" />
        <Box className="w-6 h-8 bg-green-600" />
      </Box>
    ),
  },
  {
  ...
  { name: 'h-32', render: box('w-6 h-32 bg-indigo-500') },
  {
    name: 'w-third',
    render: ({ Box }) => (
      <Box className="w-48 h-8 bg-slate-200">
        <Box id="cfm-root" className="w-1/3 h-8 bg-sky-500" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box className="w-48 h-8 bg-slate-200">
        <Box id="cfm-root" className="w-2/3 h-8 bg-rose-500" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box className="w-48 h-8 bg-slate-200">
        <Box id="cfm-root" className="w-1/4 h-8 bg-teal-500" />
      </Box>
    ),
  },
  ...
  // ── spacing breadth (padding visible inside; margin via wrapper) ─────────────
  {
    name: 'p-1',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-sky-500 p-1">
        <Box className="w-12 h-12 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'p-2',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-sky-500 p-2">
        <Box className="w-12 h-12 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'p-8',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-sky-500 p-8">
        <Box className="w-8 h-8 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'px-only',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-emerald-500 px-8">
        <Box className="w-8 h-12 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'py-only',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 bg-emerald-500 py-6">
        <Box className="w-12 h-8 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'pr-only',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 bg-violet-500 pr-10">
        <Box className="w-8 h-10 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'pb-only',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 bg-violet-500 pb-8">
        <Box className="w-10 h-8 bg-slate-900" />
      </Box>
    ),
  },
  {
    name: 'margin-inner',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-32 h-16 bg-slate-200">
        <Box className="m-4 w-8 h-8 bg-blue-600" />
      </Box>
    ),
  },
  {
    name: 'margin-top-inner',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-20 h-24 bg-slate-200">
        <Box className="mt-6 w-12 h-8 bg-blue-600" />
      </Box>
    ),
  },
  ...
  {
    name: 'border-rounded',
    render: box('w-20 h-20 bg-amber-100 border-4 border-rose-500 rounded-xl'),
  },
  ...
  },
  {
    name: 'items-stretch',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row items-stretch w-32 h-16 bg-slate-200">
        <Box className="w-8 bg-blue-600" />
      </Box>
    ),
  },
  {
    name: 'justify-start',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row justify-start w-32 h-10 bg-slate-200">
        <Box className="w-8 h-8 bg-blue-600" />
      </Box>
    ),
  },
  {
    name: 'justify-evenly',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row justify-evenly w-40 h-10 bg-slate-200">
        <Box className="w-6 h-8 bg-red-600" />
        <Box className="w-6 h-8 bg-green-600" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row items-start w-32 h-20 bg-slate-200">
        <Box className="w-8 h-8 bg-violet-600 self-center" />
      </Box>
    ),
  },
  {
    name: 'self-stretch',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row items-start w-32 h-16 bg-slate-200">
        <Box className="w-8 bg-violet-600 self-stretch" />
      </Box>
    ),
  },
  {
    name: 'flex-col-3',
    render: ({ Box }) => (
      <Box id="cfm-root" className="w-24 flex flex-col gap-2 p-2 bg-slate-200">
        <Box className="w-10 h-5 bg-red-500" />
        <Box className="w-10 h-5 bg-green-500" />
        <Box className="w-10 h-5 bg-blue-500" />
      </Box>
    ),
  },
  {
    name: 'flex-wrap-many',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row flex-wrap gap-1 w-24 bg-slate-200">
        {[0, 1, 2, 3, 4, 5].map((i) => (
          <Box key={i} className="w-10 h-10 bg-indigo-500" />
        ))}
      </Box>
    ),
  },
  {
    name: 'grow-shrink',
    render: ({ Box }) => (
      <Box id="cfm-root" className="flex flex-row w-40 h-8 bg-slate-200">
        <Box className="grow bg-red-500" />
        <Box className="w-12 bg-blue-500" />
      </Box>
    ),
  },
  ...
  // ── position breadth ────────────────────────────────────────────────────────
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="relative w-24 h-24 bg-slate-200">
        <Box className="absolute top-1 right-1 w-8 h-8 bg-emerald-600" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="relative w-24 h-24 bg-slate-200">
        <Box className="absolute bottom-1 left-1 w-8 h-8 bg-amber-600" />
      </Box>
    ),
  },
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="relative w-24 h-24 bg-slate-200">
        <Box className="absolute top-8 left-8 w-8 h-8 bg-fuchsia-600" />
      </Box>
    ),
  },
  ...
  // ── typography (web-strong; native glyph rasterization differs → skip native) ─
  {
    ...
    skip: ['native'],
    render: ({ Box, Text }) => (
      <Box id="cfm-root" className="w-40 bg-slate-100">
  ...
  },
  {
    ...
    render: ({ Box, Text }) => (
      <Box id="cfm-root" className="w-40 bg-slate-100">
        <Text className="text-right">aligned</Text>
      </Box>
    ),
  },
  ...
  { name: 'gap-border-t', render: box('w-20 h-20 bg-white border-t-4 border-blue-600') }, // single-side border
  {
    ...
    render: ({ Box }) => (
      <Box id="cfm-root" className="relative w-24 h-24 bg-slate-200">
        <Box className="absolute inset-x-0 top-2 h-8 bg-indigo-500" />
      </Box>
    ),
  },
]
