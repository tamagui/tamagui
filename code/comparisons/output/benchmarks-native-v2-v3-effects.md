...
Derived from the authoritative JSON (SHA-256 `c759666e9e3d5bc2eb9c181e49355b409d333d940de1de719b4460a03fffc895`). Ratio of means is right/left. Paired difference is right minus left in milliseconds; each 95% CI uses 30 round-paired retained differences (Student t, df=29).
...
| compiled V3 versus V2 | simple | mount | 5.094674 | 21.256422 | 20.516279 to 21.996565 |
| compiled V3 versus V2 | simple | update | 0.971911 | -0.029131 | -0.063276 to 0.005014 |
| compiled V3 versus V2 | simple | remount | 5.282232 | 21.057233 | 20.538869 to 21.575598 |
| compiled V3 versus V2 | nested-static | mount | 4.767966 | 31.504446 | 30.733924 to 32.274968 |
| compiled V3 versus V2 | nested-static | update | 0.901985 | -0.053101 | -0.076763 to -0.029440 |
| compiled V3 versus V2 | nested-static | remount | 5.016079 | 32.154076 | 31.442661 to 32.865492 |
| compiled V3 versus V2 | styled-static | mount | 1.381442 | 3.585007 | 2.991574 to 4.178440 |
| compiled V3 versus V2 | styled-static | update | 0.944911 | -0.026324 | -0.046727 to -0.005920 |
| compiled V3 versus V2 | styled-static | remount | 1.276183 | 2.662071 | 2.239658 to 3.084483 |
...
| V3 compiler effect | simple | mount | 0.962253 | -1.037488 | -2.219461 to 0.144486 |
| V3 compiler effect | simple | update | 0.042166 | -22.895967 | -23.699004 to -22.092930 |
| V3 compiler effect | simple | remount | 0.964532 | -0.955142 | -1.706993 to -0.203290 |
