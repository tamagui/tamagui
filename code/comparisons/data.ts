  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'none', tailwind: 'web-only', nativewind: 'none', uniwind: 'none' },
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'none', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'appearance-none resets browser-native control chrome — a web-only concept. RN controls are already custom-rendered, so there is nothing to reset. Tamagui: none.',
      },
      {
        name: 'field-sizing',
        ...
        support: { tamagui: 'none', tailwind: 'web-only', nativewind: 'none', uniwind: 'none' },
        notes: 'field-sizing-content/fixed is new in Tailwind v4.0 and maps to the CSS `field-sizing` property (web only). RN auto-grows a TextInput via the `multiline` + onContentSizeChange pattern instead. Tamagui/NativeWind/Uniwind have no field-sizing utility.',
      },
      {
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'none', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Forced-colors is a web/OS high-contrast feature. Tailwind v4 ships the `forced-colors:` variant + `forced-color-adjust-*` (both since v3.4); NativeWind exposes them web-only. RN has its own high-contrast handling, so no native style mapping. Tamagui: none.',
      },
    ],
  },
