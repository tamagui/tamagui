  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        notes: 'Not applicable to RN flexbox model. Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent.',
      },
      {
        name: 'clear',
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent.',
      },
      {
        name: 'columns',
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; CSS grid alignment only renders on web, no native equivalent.',
      },
    ],
  },
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        examples: {
          tamagui: '$platform-web={{ textIndent: 16 }}',
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent (RN has no CSS background image).',
      },
      {
    ...
    utilities: [
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent (RN has no <table>).',
      },
      {
        name: 'border-spacing',
        description: 'Table border spacing',
        examples: {
          tamagui: '$platform-web={{ borderSpacing: 8 }}',
    ...
    utilities: [
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent (RN uses ScrollView animated APIs instead).',
      },
      {
        name: 'scroll-snap',
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; on native, ScrollView has `pagingEnabled` / `snapToInterval` / `snapToOffsets` props (different API surface).',
      },
      {
        name: 'touch-action',
      ...
      },
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; only applies to <textarea>-like elements anyway, no native equivalent.',
      },
      {
        name: 'appearance',
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'appearance-none resets browser-native control chrome — a web-only concept. RN controls are already custom-rendered, so there is nothing to reset. Tamagui: reachable on web via `$platform-web={{ ... }}`.',
      },
      {
        name: 'field-sizing',
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'none', uniwind: 'none' },
        notes: 'field-sizing-content/fixed is new in Tailwind v4.0 and maps to the CSS `field-sizing` property (web only). RN auto-grows a TextInput via the `multiline` + onContentSizeChange pattern instead. Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; NativeWind/Uniwind have no field-sizing utility.',
      },
      {
      ...
      },
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Tamagui: reachable on web via the `$platform-web={{ ... }}` escape hatch; no native equivalent (RN form controls take explicit props like `tintColor`).',
      },
      {
        name: 'will-change',
  ...
  // ═══════════════════════════════════════
  {
    ...
    utilities: [
      ...
      },
      {
        ...
        support: { tamagui: 'web-only', tailwind: 'web-only', nativewind: 'web-only', uniwind: 'none' },
        notes: 'Forced-colors is a web/OS high-contrast feature. Tailwind v4 ships the `forced-colors:` variant + `forced-color-adjust-*` (both since v3.4); NativeWind exposes them web-only. RN has its own high-contrast handling, so no native style mapping. Tamagui: the `forced-color-adjust` CSS property is reachable on web via the `$platform-web={{ ... }}` escape hatch; there is no `$forcedColors:` media variant.',
      },
    ],
  },
