...
function DelayDemoContent({
  ...
  return (
    <YStack
                  gap="3" p="4" bg="background" borderWidth={1} borderColor="border-color" width={260}
                >
...
const ThemeAccent = () => {
  return (
    <YStack gap="4" p="4">
      ...
      <XStack gap="4">
        <YStack
                                      gap="2" bg="background" p="4" borderWidth={2} borderColor="border-color" flex={1}
                                    >
          <ThemeDebug />
        ...
        <Theme name="dark">
          <YStack
                                                gap="2" bg="red" p="4" borderWidth={2} borderColor="border-color" flex={1}
                                              >
            <ThemeDebug />
      ...
      <XStack gap="4">
        <Theme name="light">
          <YStack
                                                gap="2" bg="background02" p="4" borderWidth={2} borderColor="border-color" flex={1}
                                              >
            <ThemeDebug />
      ...
      <XStack gap="4" flexWrap="wrap">
        <Theme name="light">
          <YStack
                                                gap="2" bg="background02" p="4" borderWidth={2} borderColor="border-color" minW={200}
                                              >
            <ThemeDebug />
    ...
    <>
      <Configuration animationDriver={animationsMotion}>
        <YStack group="card" gap={50}>
          <XStack
                                                transition={[ 'bouncy', { stiffness: 250, damping: 4, mass: 0.5, }, ]} width={100} height={100} bg="red" scale="1 group-hover/card:1.5"
                                              />
          <XStack
                                                transition={'bouncy'} width={100} height={100} bg="blue" scale="1 group-hover/card:1.5"
                                              />
        </YStack>
      </Configuration>
