---
title: Migrating from Create React App to One
...
<IntroParagraph>
Transitioning from Create React App (CRA) to One is a straightforward process that unlocks a world of performance improvements and modern development features.
</IntroParagraph>

One is a build system and React framework for web, iOS, and Android, built on the power of Vite. It offers faster build times, better developer experience, and seamless cross-platform development capabilities.
