...
<Notice>
  If you just want to run your iOS app in development mode without any custom native dependencies added, you won't need to follow this guide at all.

  All you need is an iOS device with [Expo Go](https://apps.apple.com/us/app/expo-go/id982107779) installed, then press the key combination <kbd>q</kbd>, <kbd>r</kbd> in your terminal which is running the One dev server, and follow the instructions to open the app in Expo Go.
</Notice>
...
<Notice>
  We've ususlly done this for you in our project template, so you can skip this section if you've created your project with `npx one`.
</Notice>
