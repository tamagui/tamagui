...
const ToastRoot = React.forwardRef<TamaguiElement, ToastRootProps>(function ToastRoot(
  props,
  _ref
) {
  const {
...
const ToastItemInner = ToastItemFrame.styleable<ToastItemProps>(function ToastItem(
  props,
  ref
) {
