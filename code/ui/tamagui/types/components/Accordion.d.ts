...
export declare const Accordion: ((props: (((import("@tamagui/ui").AccordionMultipleProps | import("@tamagui/ui").AccordionSingleProps) & {
    ...
    Header: import("@tamagui/ui").RefComponent<import("@tamagui/ui").TamaguiTextElement, Omit<Omit<import("@tamagui/ui").TextNonStyleProps, "size" | "unstyled" | keyof import("@tamagui/web").TextStylePropsBase> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
