...
export declare const CheckboxFrame: import('react').FunctionComponent<
  Omit<
                  ...
                  import('@tamagui/web').InferStyleProps<
                    React.FunctionComponent<
                      ...
                      > &
                        ...
                        > & {
                          ref?:
                            | React.Ref<import('@tamagui/ui').TamaguiElement>
                            | undefined
                        }
                    > &
                      import('@tamagui/web').StaticComponentObject<
...
export declare const CheckboxIndicator: import('react').FunctionComponent<
  Omit<
    import('@tamagui/core').RNTamaguiViewNonStyleProps &
      Omit<
        import('@tamagui/core').RNTamaguiViewNonStyleProps,
        'active' | 'activeStyle' | 'size' | keyof import('@tamagui/web').StackStyleBase
      > &
      import('@tamagui/web').WithThemeValues<
        import('@tamagui/web').StackStyleBase & {
          readonly activeStyle?:
