...
export declare const DialogOverlay: React.FunctionComponent<
  Omit<
...
export declare const DialogContent: React.FunctionComponent<
  Omit<
    import('@tamagui/core').RNTamaguiViewNonStyleProps &
      Omit<
        Omit<
        ...
        > &
          ...
          Omit<import('@tamagui/dismissable').DismissableProps, 'onDismiss'> & {
            ...
            context: {
              ...
              onOpenChange: Exclude<
                import('@tamagui/ui').DialogProps['onOpenChange'],
                void | null
              >
    ...
    'bordered' | 'elevate' | 'elevation' | keyof import('@tamagui/web').StackStyleBase
  > &
    import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase> & {
      bordered?: boolean | undefined
      elevate?: boolean | undefined
...
export declare const Dialog: ((
  ...
  Trigger: import('@tamagui/ui').TamaguiComponent<
    ...
    import('@tamagui/web').StaticConfigPublic
  >
  Portal: import('@tamagui/ui').RefComponent<
    TamaguiElement,
    import('@tamagui/ui').DialogPortalProps
  >
  ...
  Description: import('@tamagui/ui').TamaguiComponent<
    ...
    import('@tamagui/web').StaticConfigPublic
  >
  Close: import('@tamagui/ui').TamaguiComponent<
    Omit<
      import('@tamagui/web').GetFinalProps<
        import('@tamagui/core').RNTamaguiViewNonStyleProps,
        import('@tamagui/web').StackStyleBase,
