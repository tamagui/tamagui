...
export declare const buttonSizes: import("@tamagui/size").CreatedSizeTable<{
    readonly small: {
        readonly frame: {
            readonly gap: 6;
            readonly height: 30;
...
declare const ButtonComponent: import("@tamagui/ui").TamaguiComponent<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/ui").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
    ...
    circular?: boolean | undefined;
    variant?: "outlined" | "quiet" | undefined;
}>, "value" | "size" | "icon" | "form" | "name" | "scaleIcon" | "textProps" | "noTextWrap" | keyof import("@tamagui/ui").TextContextStyles | "iconAfter" | "iconSize" | "type" | "formAction" | "formEncType" | "formMethod" | "formNoValidate" | "formTarget"> & import("@tamagui/ui").TextContextStyles & {
