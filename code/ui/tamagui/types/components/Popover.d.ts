...
export declare const PopoverContent: React.FunctionComponent<
  Omit<
    import('@tamagui/core').RNTamaguiViewNonStyleProps &
      import('@tamagui/ui').PopoverContentTypeProps,
...
export declare const PopoverArrow: React.FunctionComponent<
  Omit<
    import('@tamagui/core').RNTamaguiViewNonStyleProps &
      import('@tamagui/ui').PopperArrowExtraProps,
    keyof import('@tamagui/web').StackStyleBase
  > &
    import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase> &
    import('@tamagui/web').WithShorthands<
...
export declare const Popover: ((
  props: Omit<import('@tamagui/ui').PopperProps, 'scope'> & {
    ...
    zIndex?: number
  } & import('@tamagui/ui').RefProp<UiPopover>
) => React.ReactNode) & {
  displayName?: string
  propTypes?: any
} & {
  Anchor: React.NamedExoticComponent<
    Omit<import('@tamagui/ui').YStackProps, 'scope'> & {
      scope?: import('@tamagui/ui').PopoverScopes
  ...
  Trigger: React.NamedExoticComponent<
    Omit<
  ...
  Close: import('@tamagui/ui').RefComponent<
    import('@tamagui/ui').TamaguiElement,
    import('@tamagui/ui').PopoverCloseProps
  >
  Adapt: ((
    props: import('@tamagui/ui').AdaptProps
  ) => import('react/jsx-runtime').JSX.Element) & {
    Contents: typeof import('@tamagui/ui').AdaptContents
  }
  ScrollView: import('@tamagui/ui').RefComponent<
    import('@tamagui/ui').ScrollViewRef,
    import('@tamagui/ui').PopoverScrollViewProps
  >
  FocusScope: (
