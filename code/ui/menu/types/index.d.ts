...
export declare const Menu: import('react').FC<
  import('./createNonNativeMenu').MenuProps & {
    ...
    >
> & {
  readonly Trigger: import('react').FC<
    Omit<
    ...
    > &
      ...
      >
  >
  readonly Portal: import('react').FC<
    import('@tamagui/create-menu').MenuPortalProps & {
      ...
      >
  >
  readonly Content: import('react').FC<
    Omit<
      Omit<
    ...
    > &
      ...
      >
  >
  readonly Group: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly Label: import('react').FC<
    Omit<
  ...
  readonly Item: import('react').FC<
    ...
    > &
      ...
      >
  >
  readonly CheckboxItem: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly RadioGroup: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly RadioItem: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly ItemIndicator: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly Separator: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
    ...
    > &
      ...
      >
  >
  readonly Arrow: import('react').FC<
    Omit<
  ...
  readonly Sub: import('react').FC<
    import('@tamagui/create-menu').MenuSubProps & {
      ...
      >
  >
  readonly SubTrigger: import('react').FC<
    import('@tamagui/create-menu').MenuSubTriggerProps & {
      ...
      >
  >
  readonly SubContent: import('react').FC<
    Omit<
      Omit<
        import('@tamagui/web').GetFinalProps<
          import('@tamagui/core').RNTamaguiViewNonStyleProps,
    ...
    > &
      ...
      >
  >
  readonly ItemTitle: import('react').FC<
    Omit<
      import('@tamagui/web').TextProps,
    ...
    > &
      ...
      >
  >
  readonly ItemSubtitle: import('react').FC<
    Omit<
      import('@tamagui/web').TextProps,
    ...
    > &
      ...
      >
  >
  readonly ItemIcon: import('react').FC<
    Omit<
      import('@tamagui/web').ViewProps,
      | keyof import('@tamagui/web').StackNonStyleProps
      | keyof import('@tamagui/web').StackStyleBase
    > &
      ...
      >
  >
  readonly ItemImage: import('react').FC<
    import('@tamagui/web').StackNonStyleProps &
      import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase> &
      import('@tamagui/web').WithShorthands<
        import('@tamagui/web').WithThemeValues<import('@tamagui/web').StackStyleBase>
  ...
  readonly ScrollView:
    ...
    | (import('react').FunctionComponent<
        ...
        > &
          ...
          > & {
            ref?:
              | import('react').Ref<import('@tamagui/scroll-view').ScrollViewRef>
              | undefined
          }
      > &
