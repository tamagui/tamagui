...
export declare function createNonNativeMenu(): {
  ...
  Trigger: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof MenuTriggerProps> &
      MenuTriggerProps & {
        scope?: string
      },
    TamaguiElement,
    ...
    Omit<
      Omit<
        import('@tamagui/web').GetFinalProps<
          ...
          {}
        >,
        keyof BaseMenuContentProps
      > &
        BaseMenuContentProps & {
          scope?: string
        },
      keyof MenuContentProps
    > &
      MenuContentProps & {
        scope?: string
      },
  ...
  Group: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, keyof BaseMenuGroupProps> & BaseMenuGroupProps,
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps & BaseMenuGroupProps,
    import('@tamagui/web').StackStyleBase,
    {},
    {}
  >
  Label: import('@tamagui/web').TamaguiComponent<
    Omit<import('@tamagui/web').TextProps, keyof BaseMenuLabelProps> & BaseMenuLabelProps,
    import('@tamagui/web').TamaguiTextElement,
    import('@tamagui/web').TextNonStyleProps & BaseMenuLabelProps,
    import('@tamagui/web').TextStylePropsBase,
    {},
    {}
  >
  Item: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuItemProps> &
      BaseMenuItemProps & {
        scope?: string
      },
    TamaguiElement,
    ...
    {}
  >
  CheckboxItem: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuCheckboxItemProps> &
    ...
    {}
  >
  RadioGroup: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuRadioGroupProps> &
      BaseMenuRadioGroupProps & {
        scope?: string
      },
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps &
    ...
    {}
  >
  RadioItem: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuRadioItemProps> &
  ...
  ItemIndicator: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuItemIndicatorProps> &
      BaseMenuItemIndicatorProps & {
        scope?: string
      },
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps &
  ...
  Separator: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, keyof BaseMenuSeparatorProps> & BaseMenuSeparatorProps,
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps & BaseMenuSeparatorProps,
    import('@tamagui/web').StackStyleBase,
    {},
    {}
  >
  Arrow: import('@tamagui/web').RefComponent<
    TamaguiElement,
    Omit<
      import('@tamagui/web').StackNonStyleProps &
        ...
        import('@tamagui/web').RefProp<TamaguiElement>,
      'ref'
    >
  >
  Sub: {
  ...
  SubTrigger: import('@tamagui/web').RefComponent<
    TamaguiElement,
    ...
    Omit<
      Omit<
        import('@tamagui/web').GetFinalProps<
          ...
          {}
        >,
        keyof BaseMenuSubContentProps
      > &
        BaseMenuSubContentProps & {
          scope?: string
        },
      keyof BaseMenuSubContentProps
    > &
  ...
  ItemSubtitle: import('@tamagui/web').TamaguiComponent<
    ...
    {}
  >
  ItemImage: import('@tamagui/web').RefComponent<
    TamaguiElement,
