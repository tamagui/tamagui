...
export declare const Tooltip: React.ForwardRefExoticComponent<Omit<PopperProps & {
    ...
    }>, "elevation"> & import("@tamagui/stacks").StackVariants & import("@tamagui/popper").PopperArrowExtraProps & React.RefAttributes<TamaguiElement>>;
