...
export type FocusOutsideDetails = TamaguiChangeEventDetails<'focus-out', FocusEvent, {
    interaction: 'focus';
}>;
export type InteractOutsideDetails = PointerDownOutsideDetails | FocusOutsideDetails;
export type DismissableDismissDetails = TamaguiEventDetails<'escape-key', React.KeyboardEvent> | TamaguiEventDetails<'outside-press', PointerEvent, {
    interaction: 'pointer';
}> | TamaguiEventDetails<'focus-out', FocusEvent, {
    interaction: 'focus';
}>;
export interface DismissableProps {
     ...
     * Can be canceled.
     */
    onEscapeKeyDown?: (details: TamaguiChangeEventDetails<'escape-key', React.KeyboardEvent>) => void;
    /**
