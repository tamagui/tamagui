...
export declare function createNonNativeContextMenu(params: CreateBaseMenuProps): {
    ...
    Item: import("@tamagui/compose-refs").RefComponent<TamaguiElement, ScopedProps<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    CheckboxItem: import("@tamagui/compose-refs").RefComponent<TamaguiElement, ScopedProps<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    RadioGroup: import("@tamagui/compose-refs").RefComponent<(HTMLElement & import("@tamagui/web").TamaguiElementMethods) | import("react-native").View, ScopedProps<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    RadioItem: import("@tamagui/compose-refs").RefComponent<TamaguiElement, ScopedProps<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    ItemIndicator: import("@tamagui/web").TamaguiComponent<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        ...
        scope?: string;
    }, "scope" | keyof BaseMenuTypes.MenuItemIndicatorProps> & Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/web").StackNonStyleProps, import("@tamagui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    }>, "scope" | keyof BaseMenuTypes.MenuItemIndicatorProps> & BaseMenuTypes.MenuItemIndicatorProps & {
        scope?: string;
    } & {
    ...
    Arrow: import("@tamagui/compose-refs").RefComponent<TamaguiElement, ScopedProps<Omit<BaseMenuTypes.MenuArrowProps & import("@tamagui/compose-refs").RefProp<TamaguiElement>, "ref">>>;
    Sub: {
    ...
    SubContent: import("@tamagui/compose-refs").RefComponent<(HTMLElement & import("@tamagui/web").TamaguiElementMethods) | import("react-native").View, ScopedProps<Omit<Omit<import("@tamagui/web").GetFinalProps<import("@tamagui/core").RNTamaguiViewNonStyleProps, import("@tamagui/web").StackStyleBase, {
    ...
    ItemImage: import("@tamagui/compose-refs").RefComponent<import("react-native").Image, import("react-native").ImageProps>;
    Preview: () => null;
};
