...
export declare function createNonNativeContextMenu(): {
  ...
  Trigger: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof ContextMenuTriggerProps> &
    ...
    Omit<
      Omit<
        import('@tamagui/web').GetFinalProps<
          ...
          {}
        >,
        keyof BaseMenuTypes.MenuContentProps
      > &
        BaseMenuTypes.MenuContentProps & {
          scope?: string
        },
      keyof ContextMenuContentProps
    > &
  ...
  Group: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, keyof BaseMenuTypes.MenuGroupProps> & BaseMenuTypes.MenuGroupProps,
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps & BaseMenuTypes.MenuGroupProps,
    import('@tamagui/web').StackStyleBase,
    {},
    {}
  >
  Label: import('@tamagui/web').TamaguiComponent<
    Omit<import('@tamagui/web').TextProps, keyof BaseMenuTypes.MenuLabelProps> &
      BaseMenuTypes.MenuLabelProps,
    import('@tamagui/web').TamaguiTextElement,
    import('@tamagui/web').TextNonStyleProps & BaseMenuTypes.MenuLabelProps,
  ...
  Item: import('@tamagui/compose-refs').RefComponent<
    ...
    ScopedProps<
      Omit<
        Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuItemProps> &
          BaseMenuTypes.MenuItemProps & {
            scope?: string
          } & {
    ...
    >
  >
  CheckboxItem: import('@tamagui/compose-refs').RefComponent<
    TamaguiElement,
    ScopedProps<
      Omit<
        Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuCheckboxItemProps> &
          BaseMenuTypes.MenuCheckboxItemProps & {
            scope?: string
          } & {
            ref?: React.Ref<TamaguiElement> | undefined
          },
    ...
    >
  >
  RadioGroup: import('@tamagui/compose-refs').RefComponent<
    | import('react-native').View
    | (HTMLElement & import('@tamagui/web').TamaguiElementMethods),
    ScopedProps<
      Omit<
        Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuRadioGroupProps> &
          BaseMenuTypes.MenuRadioGroupProps & {
            scope?: string
          } & {
            ref?: React.Ref<TamaguiElement> | undefined
          },
    ...
    >
  >
  RadioItem: import('@tamagui/compose-refs').RefComponent<
    TamaguiElement,
    ScopedProps<
      Omit<
        Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuRadioItemProps> &
          BaseMenuTypes.MenuRadioItemProps & {
            scope?: string
          } & {
            ref?: React.Ref<TamaguiElement> | undefined
          },
    ...
    >
  >
  ItemIndicator: import('@tamagui/web').TamaguiComponent<
    Omit<
      Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuItemIndicatorProps> &
        BaseMenuTypes.MenuItemIndicatorProps & {
          scope?: string
        },
      'scope' | keyof BaseMenuTypes.MenuItemIndicatorProps
    > &
      Omit<
        Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuItemIndicatorProps> &
          BaseMenuTypes.MenuItemIndicatorProps & {
  ...
  Separator: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, keyof BaseMenuTypes.MenuSeparatorProps> &
      BaseMenuTypes.MenuSeparatorProps,
    TamaguiElement,
    import('@tamagui/web').StackNonStyleProps & BaseMenuTypes.MenuSeparatorProps,
    import('@tamagui/web').StackStyleBase,
    {},
    {}
  >
  Arrow: import('@tamagui/compose-refs').RefComponent<
    TamaguiElement,
    ScopedProps<
      Omit<
        Omit<
  ...
  SubTrigger: import('@tamagui/web').TamaguiComponent<
    Omit<ViewProps, 'scope' | keyof BaseMenuTypes.MenuSubTriggerProps> &
      Omit<
    ...
    {}
  >
  SubContent: import('@tamagui/web').TamaguiComponent<
    Omit<
      Omit<
        import('@tamagui/web').GetFinalProps<
          import('@tamagui/core').RNTamaguiViewNonStyleProps,
          ...
          {}
        >,
        keyof BaseMenuTypes.MenuSubContentProps
      > &
        BaseMenuTypes.MenuSubContentProps & {
          scope?: string
        },
      | 'download'
      | 'elevationAndroid'
    ...
    import('@tamagui/web').StaticConfigPublic
  >
  ItemTitle: import('@tamagui/web').TamaguiComponent<
    Omit<import('@tamagui/web').TextProps, keyof BaseMenuTypes.MenuItemTitleProps> &
      BaseMenuTypes.MenuItemTitleProps,
    import('@tamagui/web').TamaguiTextElement,
    import('@tamagui/web').TextNonStyleProps & BaseMenuTypes.MenuItemTitleProps,
    import('@tamagui/web').TextStylePropsBase,
    {},
    {}
  >
  ItemSubtitle: import('@tamagui/web').TamaguiComponent<
    Omit<import('@tamagui/web').TextProps, keyof BaseMenuTypes.MenuItemSubTitleProps> &
      BaseMenuTypes.MenuItemSubTitleProps,
    import('@tamagui/web').TamaguiTextElement,
    import('@tamagui/web').TextNonStyleProps & BaseMenuTypes.MenuItemSubTitleProps,
    import('@tamagui/web').TextStylePropsBase,
    {},
    {}
  >
  ItemIcon: import('@tamagui/web').TamaguiComponent<
    ...
    {}
  >
  ItemImage: import('@tamagui/compose-refs').RefComponent<
    TamaguiElement,
    import('@tamagui/image').ImageProps
  >
  Preview: () => null
}
export type {
