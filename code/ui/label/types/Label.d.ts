...
export declare const LabelFrame: React.FunctionComponent<
  Omit<
    import('@tamagui/web').TextNonStyleProps,
    'size' | keyof import('@tamagui/web').TextStylePropsBase
  > &
    import('@tamagui/web').WithThemeValues<import('@tamagui/web').TextStylePropsBase> & {
      size?:
        | string
        | number
        | boolean
...
export declare const Label: import('@tamagui/web').TamaguiComponent<
  import('@tamagui/web').TamaDefer,
