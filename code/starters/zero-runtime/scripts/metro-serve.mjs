// Serves the starter's Metro web build: the entry HTML, the zero bundle, and
// the published CSS artifact and island bundles.
...
createServer((request, response) => {
  ...
  console.info(`metro starter on http://localhost:${port}`)
})
