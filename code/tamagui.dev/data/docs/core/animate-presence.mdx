...
To use with `@tamagui/style`, install and import `@tamagui/animate-presence`. It's already bundled and exported from `tamagui`.

## Basic Usage

Use `enter:` and `exit:` clauses to define how each property animates in and out:
