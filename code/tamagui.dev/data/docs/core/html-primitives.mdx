---
title: HTML elements
description: Semantic HTML elements that render on web and native, in early development
---
...
Each member is an ordinary Tamagui component, so it takes Tamagui style props
...
differently on native. [`View` and `Text`](/docs/core/view-and-text) are flex
