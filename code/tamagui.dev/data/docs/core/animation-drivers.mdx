...
With [`@tamagui/config/v6`](/docs/core/config-v6), add one animation entry for your platform. The entries share matching keys:
...
Use CSS, Motion, or Reanimated on web.
