...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description:
        'Component themes. V5 includes only Button and Tooltip by default. Pass false to disable.',
    },
  ]}
/>
...
V5 includes only **Button** and **Tooltip** component themes by default, a
significant reduction from v4. We plan to remove component themes entirely in
Tamagui v3, as they can be confusing and it's easier to style components
directly using the `theme` prop.

The default component themes in v5:

- **Button**: `surface3` template
- **Tooltip**: `inverse` template

You can disable component themes entirely or customize them:
...
5. **Component themes** v5 has less component themes, you can bring them back by
   copying the v5 componentThemes templates.
