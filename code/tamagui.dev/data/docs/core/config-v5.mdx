...
<PropsTable
  data={[
    ...
    },
    {
      ...
      default: 'false',
      description:
        'Component themes (defaults to false in v5). You can still pass custom component themes, but we recommend using defaultProps instead.',
    },
  ]}
/>
...
### Migrating from Component Themes {#migrating-from-component-themes}
