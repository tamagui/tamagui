...
<PropsTable
  data={[
    { name: '2xl', description: `maxWidth: 1536` },
    { name: 'xl', description: `maxWidth: 1280` },
    { name: 'lg', description: `maxWidth: 1024` },
    { name: 'md', description: `maxWidth: 768` },
    { name: 'sm', description: `maxWidth: 640` },
    { name: 'xs', description: `maxWidth: 460` },
    { name: '2xs', description: `maxWidth: 340` },
  ]}
/>

Every media query defaults to `true` to align with [mobile-first design](https://en.wikipedia.org/wiki/Responsive_web_design).
