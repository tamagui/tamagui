...
Specify different transitions for entering and exiting pseudo states like
hover, press, and focus. Entering a state uses that state's transition, and
exiting uses the base transition:
