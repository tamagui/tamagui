...
<IntroParagraph>
  Tamagui animates style props through swappable drivers, with the same
  component API across web and native.
</IntroParagraph>
...
```tsx
<html.div transition="quick" scale={{ default: 1, hover: 1.1 }} />
```
...
```tsx
<html.div transition="quick" opacity={{ default: 1, enter: 0 }} />
```
...
<html.div group="card">
  <Square
    size={50}
    bg="color-5 group-hover/card:color-10"
