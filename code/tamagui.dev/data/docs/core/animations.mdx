...
The `transition` prop accepts a string or a two-arity array to customize
animations per-property.

You can set a default animation with overrides for specific properties using the array syntax:
