...
You can set up as much or little of `@tamagui/core` as you like, and just use it out of the box:
...
Create a `tamagui.config.ts` near the root of your app, and only import it to pass it to your [TamaguiProvider](#tamaguiprovider) near the root of your app. This prevents circular import issues. You can get your config from anywhere with `getConfig`. Here's a simple example of a configuration:

A very simple `@tamagui/core` could look like this:
