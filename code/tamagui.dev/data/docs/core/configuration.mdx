...
<Notice theme="green">
  ...
  style library only, you can change the imports in this guide out for `@tamagui/style`,
...
// To work with the Tamagui Components styled components (which is optional)
