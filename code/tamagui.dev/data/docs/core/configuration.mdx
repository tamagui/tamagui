...
You need to load your fonts for React Native to recognize them. With Expo, this typically
looks something like this (or you can
...
<Notice theme="green">
  For a full shorthands setup, see [the @tamagui/shorthands source](https://github.com/tamagui/tamagui/blob/master/code/core/shorthands/src/index.ts).
</Notice>
