...
| [Linear Gradient](#linear-gradient)           | `expo-linear-gradient`              | Native gradient rendering                                |
...
`LinearGradient` renders with `expo-linear-gradient` on native.
...
See [LinearGradient](/ui/linear-gradient).
