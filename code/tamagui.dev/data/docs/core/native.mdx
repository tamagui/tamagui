...
<IntroParagraph>
  Tamagui core renders native views on iOS and Android with the same components,
  tokens, and themes you use on web.
</IntroParagraph>

Configure it with the same [provider](/docs/core/configuration) you use on web.
