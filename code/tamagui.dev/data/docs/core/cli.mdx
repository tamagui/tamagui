...
Pair it with [migrate](#migrate) for projects already on v1 or v2. See
[Set up with an agent](/docs/intro/installation#set-up-with-an-agent) for the copy-paste prompts.
