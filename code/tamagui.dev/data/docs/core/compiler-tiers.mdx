...
<IntroParagraph>
  ...
  configuration-static CSS into a build artifact, or enforce a web entry with
  no Tamagui component runtime.
</IntroParagraph>

Inside an ordinary compiled app, each component is handled independently. One
dynamic component does not turn extraction off for the rest of the file.
