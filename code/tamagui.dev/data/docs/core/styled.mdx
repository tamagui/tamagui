...
```tsx
import { GetProps, View, styled } from '@tamagui/style'
...
```tsx
import { type SizeTokens, View, styled } from '@tamagui/style'
...
import { styled } from 'tamagui' // or '@tamagui/style'
...
```tsx
import { TamaguiComponentState } from '@tamagui/style'
;<View
...
```tsx
import { createStyledHOC, View, ViewProps } from '@tamagui/style'
