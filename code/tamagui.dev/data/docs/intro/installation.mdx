...
See the [configuration documentation](/docs/core/configuration) docs for a comprehensive overview of what can be in your config. If you'd like to get started more quickly with presets, we have `@tamagui/config`:
