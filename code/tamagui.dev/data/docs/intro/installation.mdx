...
- **React 18+**
- **React Native 0.83+** (for native apps)

Tamagui v2 uses web-standard props (`aria-*`, `role`, `tabIndex`) for accessibility,
which require React Native 0.83 or later for proper support on native platforms.
