...
<IntroParagraph>
  Tamagui is easy to set up as we've invested into "0-config" installs for all
  bundlers. That said, it's easy to get lost if you start configuring too many
  things too early.
</IntroParagraph>
...
- **React Native 0.82+** with New Architecture enabled (for native apps)
- **React 19+**
- **TypeScript 5+** (required)

Tamagui 2 takes advantage of new style features in React Native 0.82+ including
