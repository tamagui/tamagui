...
second one [Tamagui Components](/ui/stacks) is working towards slowly.
...
{/* sized rather than scaled: a transform on a `size="hero"` figure, which already
    bleeds wider than the text column, pushed the page past the viewport */}

<YStack w="100%" items="center" my="4 md:8">
  <Image
