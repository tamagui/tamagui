...
// Cross-platform styles (RN 0.76+ with New Architecture):
type CrossPlatformStyles = {
  ...
  display?: 'flex' | 'none' | 'contents' | ...  // RN 0.77 adds 'contents' support
...
// On native (RN 0.76+): resolves to raw values
// boxShadow: "0 0 10px rgba(0,0,0,0.2)"
```

Supported shorthand properties with variable resolution:

- `boxShadow` - Works on both web and native (RN 0.76+)
