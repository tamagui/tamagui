...
type ViewStyle = WithStates & {
  ...
  $group-focusWithin?: WithStates
  $group-focusVisible?: WithStates
  $group-press?: WithStates

  // add group + container queries
  $group-sm-hover?: WithStates
  $group-sm-focus?: WithStates
  $group-sm-focusWithin?: WithStates
  $group-sm-focusVisible?: WithStates
  ...
  $group-tabs-focusWithin?: WithStates
  $group-tabs-focusVisible?: WithStates
  ...
  $group-tabs-sm-focusWithin?: WithStates
  $group-tabs-sm-focusVisible?: WithStates
...
psuedo modifiers are `hover` (web only), `press`, `focus`, `focusWithin`, and `focusVisible`.
