...
Using these standard keys is a good idea. It makes it easier for different parts of your app to match and for other developers to understand your code.

...plus all the pseudo variants for each, eg, `backgroundHover`, `backgroundPress`, and `backgroundFocus`.

This means that you can easily swap re-theme `tamagui`'s UI kit and your own components together, with light and dark mode.
