...
For complete CLI documentation including all available commands, see the [CLI Guide](/docs/guides/cli).
...
**Learn more:** See the [CLI Guide](/docs/guides/cli) for documentation on all CLI commands including `check`, `generate`, `add`, and more.
