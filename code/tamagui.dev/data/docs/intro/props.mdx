...
Tamagui v2 uses web-standard accessibility props that work across all platforms:
  ...
  data={[
    {
      ...
      description: (
        <span>
          Accessible name for the element. Screen readers announce this when the element is focused.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <span>
          Hides element from the accessibility tree.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <span>
          Indicates the checked state for checkboxes and radio buttons.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <span>
          Indicates the selected state for tabs and list items.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          Indicates that content will be updated and how to announce updates.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          Indicates whether the element is a modal dialog.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          Defines the element's role for accessibility (e.g., "button", "link", "heading").
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          Controls focus order. Use <code>0</code> to make focusable, <code>-1</code> to remove from tab order.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          Unique identifier for the element. Used with aria-labelledby/describedby.
        </span>
      ),
    },
  ]}
...
<Notice theme="yellow">
  **Migrating from v1?** React Native-specific props like `accessibilityLabel`, `accessibilityRole`, and `focusable` are removed in v2. Use the web-standard equivalents:
