...
`Switch` extends View inheriting all the [Tamagui standard props](/docs/intro/props), plus:
...
`Switch.Thumb` extends View inheriting all the [Tamagui standard props](/docs/intro/props), plus:
