...
As of the time of writing, we are using the new `3.0.x` branch, so ensure you install that. Then, you'll need to rebuild your native iOS app. This is either through Expo or plain React Native.

Finally, you set it up in JS:
