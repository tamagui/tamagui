...
<IntroParagraph>
  Group arranges related controls horizontally or vertically and shares sizing,
  shape, and disabled state with its children.
</IntroParagraph>
...
<Highlights
  features={[
    'Border radius from the size prop',
