...
Use with Input or other form elements to automatically get correct labelling by
id and aria-labelledby. You can also use the provided `useLabelContext` hook to
...
Labels extend Stack views inheriting all the
