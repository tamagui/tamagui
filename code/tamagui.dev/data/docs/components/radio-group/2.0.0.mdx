...
RadioGroup is already installed in `tamagui`, or you can install it
independently:
...
RadioGroup extend Stack views inheriting all the
...
RadioGroup.Indicator appears only when the parent Item is checked. it extends
