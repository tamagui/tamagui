...
<IntroParagraph>
  Field connects labels, controls, descriptions, validation, and error messages
  across web and native forms.
</IntroParagraph>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: `Marks the field invalid without running its validator. Useful for errors known before validation runs.`,
    },
    {
      name: 'validate',
