---
title: Image
description: A lightweight cross-platform Image with Tamagui style props
name: image
component: Image
package: image
demoName: Image
...
<IntroParagraph>
  Image provides a lightweight cross-platform image component with Tamagui
  style props and pluggable renderers.
</IntroParagraph>
