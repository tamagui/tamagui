...
Tamagui Components includes optional stack views - XStack, YStack and ZStack. They extend directly off the [View](/docs/core/view-and-text) from `@tamagui/core`.

They accept [every prop from react-native-web's View](https://necolas.github.io/react-native-web/docs/view/), as well as all [the style properties Tamagui supports](/docs/intro/props).
