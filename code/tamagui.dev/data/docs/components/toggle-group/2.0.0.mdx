...
```tsx
import { ToggleGroup } from '@tamagui/ui'
...
`ToggleGroup.Item` extend Stack views inheriting all the [Tamagui standard props](/docs/intro/props), plus:
