...
<Highlights
  features={[
    'Focus trapping: prevent focus from escaping modal dialogs and overlays.',
    'Roving tabindex: arrow-key navigation across composite widgets with a single tab stop.',
    'Auto-focus on mount and return focus on unmount.',
    'Loop focus between first and last tabbable elements.',
    'Zero focus mode via noFocus to make everything focus-inert.',
