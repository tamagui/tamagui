...
<Highlights
  features={[
    'All react-native-web props and Tamagui styles',
    'Flat media, hover, and press clauses',
    'Theme and spread-variant defaults for Paragraph',
  ]}
/>
