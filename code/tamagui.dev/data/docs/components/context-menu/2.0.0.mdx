...
<IntroParagraph>
  ContextMenu opens an accessible menu from a right click on web or a long press
  on touch devices.
</IntroParagraph>
...
<Highlights
  features={[
    ...
    'Items, icons, images, checkboxes, and groups',
    'Submenu support',
    'Modal and non-modal modes',
    'Platform-native menus on mobile',
    'Custom alignment, offsets, and positioning',
    'Native iOS and Android icons',
    'Native previews on iOS',
  ]}
/>
...
On native, `ContextMenu.Trigger` coordinates with parent Tamagui pressables
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      default: 'true',
      required: false,
      description: 'Constrains the menu to fit within available viewport space.',
    },
    {
      name: 'unstyled',
      required: false,
...
Renders the content of a sub-menu. Same props as `Content`.
