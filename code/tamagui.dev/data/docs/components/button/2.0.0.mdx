...
<Highlights
  features={[
    ...
    'Button group theming with `Button.Apply`',
  ]}
/>
...
<MDXTabs id="button-2-interactive-syntax" defaultValue="styled">
<MDXTabs.List>
...
`group-hover/btn`, `group-press/btn`, and `group-focus/btn` for
