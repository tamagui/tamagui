  ...
  data={[
    {
      ...
      description: `Set a size from your theme's size tokens (e.g., "4") or a specific number. Adjusts padding, border radius, font size, and icon size. Published to Button.Text and Button.Icon through the styled context.`,
    },
    {
      name: 'variant',
      required: false,
