...
The `value` property controls the percent, but you can override it by adjusting
the `x` property.
...
Progress extends [ThemeableStack](/docs/components/stacks#themeablestack),
getting [Tamagui standard props](/docs/intro/props), plus:
...
`Progress.Indicator` extends
[ThemeableStack](/docs/components/stacks#themeablestack), getting
[Tamagui standard props](/docs/intro/props).
