---
title: Native
description: Optional native integrations and optimized runtime for better performance and UX
name: native
---
...
1. **Press events** - `onPress` uses RNGH for more reliable press detection with
...
2. **Sheet gestures** - makes sheets feel smoother and not get confused with
   scrollable content during drags.
