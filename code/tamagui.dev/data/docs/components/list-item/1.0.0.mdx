...
ListItem only supports a limited subset of text props directly. If you need more control over state-specific text values, customize its text component with flat clauses:
...
ListItems extend View inheriting all the [Tamagui standard props](/docs/intro/props), plus:
