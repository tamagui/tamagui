...
<IntroParagraph>
  ListItem builds consistent rows from titles, subtitles, icons, images, and
  shared size or theme variants.
</IntroParagraph>
...
The `size` prop adjusts padding and the default size for the text
and icons inside. It accepts the named control sizes (`xs` through `xl`,
default `md`). See [Control Sizing](/docs/guides/sizing).
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: "'xs' | 'sm' | 'md' | 'lg' | 'xl'",
      description:
        'Adjusts padding and default font/icon sizes from the config sizing ladder (default "md"). Published to the parts through the ListItem context. See the Control Sizing guide.',
    },
    {
      name: 'color',
      required: false,
    ...
    },
    {
      ...
      type: 'number',
      description:
        'Explicitly set the size of the icon in pixels, overriding the size derived from `size`.',
    },
    {
      name: 'scaleIcon',
      required: false,
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      type: "'xs' | 'sm' | 'md' | 'lg' | 'xl'",
      description: 'Named size to apply to children ListItems.',
    },
    {
      name: 'variant',
      required: false,
