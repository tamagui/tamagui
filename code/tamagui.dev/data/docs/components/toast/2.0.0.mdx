...
The portal for toasts to be directed to. Should be used inside [ToastProvider](#toastprovider). Beyond [Stack Props](/docs/components/stacks/2.0.0), adds:
...
Should be used inside [Toast](#toast). Extends [SizableText](/docs/components/text/2.0.0#sizabletext), adding:
...
Should be used inside [Toast](#toast). Extends [Stack](/docs/components/stacks/2.0.0). You can pass `asChild` to this component and use a custom `<Button>` inside.
