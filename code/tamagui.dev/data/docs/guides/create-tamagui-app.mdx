...
<IntroParagraph>
  Start a Tamagui app from a template with the native and web tooling already
  connected.
</IntroParagraph>

## Templates

There are three starter templates:
...
Together they let you build universal apps from one codebase.
