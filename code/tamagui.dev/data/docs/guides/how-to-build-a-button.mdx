...
export const ButtonFrame = styled(View, {
  ...
  // defaultVariants win / overwrite over values passed higher up in the component tree.
  // example:
  // <Button.Props size="$lg">
  //   <Button>
  //     <Button.Text size="$sm">Hello world</Button.Text>
  //   </Button>
  // </Button.Props>
  // would render a button with size $md
  defaultVariants: {
    size: '$md',
  },
})
