...
<MDXTabs id="build-button-group-syntax" defaultValue="styled">
<MDXTabs.List>
...
<MDXTabs id="build-button-frame-syntax" defaultValue="styled">
<MDXTabs.List>
  <MDXTabs.Tab value="styled">Typed</MDXTabs.Tab>
  <MDXTabs.Tab value="string">String</MDXTabs.Tab>
</MDXTabs.List>
...
The `name` property identifies the styled component for configuration and
...
const ButtonText = createStyledHOC(Button.Text, (props: GetProps<typeof OGB.ButtonText>) => {
...
What the hell is `createStyledHOC`?
