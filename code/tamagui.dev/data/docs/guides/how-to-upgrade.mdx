...
The v3 package does not ship a Sheet codemod, so migrate each callsite using the
rules below.

If you are working inside a Tamagui source checkout, you can run its source-only
