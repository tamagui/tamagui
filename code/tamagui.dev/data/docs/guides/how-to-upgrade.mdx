...
than their text. If you compensated by selecting a much larger key, remove that
workaround: `size="11"` now means the v2-compatible 124 px control again.
...
## 14. Optional: adopt the Tailwind frontend
