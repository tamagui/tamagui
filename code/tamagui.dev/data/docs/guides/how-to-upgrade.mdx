...
while migrating the rest of the v3 API. The dynamic v5 theme builders are still
removed. Applications that generate custom v5 themes must move that generation
to the v6 recipe API or remain on Tamagui v2 until they can.
