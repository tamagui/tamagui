...
<IntroParagraph>
  [One](https://onestack.dev) is a Vite-based React framework for web, iOS, and
  Android with built-in Tamagui integration.
</IntroParagraph>
...
You now have Tamagui set up with [One](https://onestack.dev).
