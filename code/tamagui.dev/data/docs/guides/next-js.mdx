...
<IntroParagraph>
  Add Tamagui to a Next.js app with shared configuration, SSR-safe themes, and
  optional compiler extraction.
</IntroParagraph>

Running `npm create tamagui@latest` lets you choose the configured `starter-free`
Next.js app as a starting point.
...
```js showMore fileName="next.config.js"
...
static CSS file; see [Static CSS Output](#static-css-output-pages-router).
