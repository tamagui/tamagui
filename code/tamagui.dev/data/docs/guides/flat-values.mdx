...
theme values are bare names. Each property accepts a typed object or string
clauses; the two spellings render identically. V2 condition objects such as
`hoverStyle={{ backgroundColor: ... }}` have no runtime path.

<MDXTabs id="flat-values-syntax" defaultValue="styled">
<MDXTabs.List>
...
<MDXTabs id="flat-values-grammar" defaultValue="styled">
<MDXTabs.List>
  <MDXTabs.Tab value="styled">Typed</MDXTabs.Tab>
  <MDXTabs.Tab value="string">String</MDXTabs.Tab>
</MDXTabs.List>
...
<html.div
  p={{ default: '4', sm: '6' }}
  backgroundColor={{ default: 'red', hover: 'blue', 'dark:hover': 'navy' }}
  width={{ default: '100%', md: '42rem' }}
  boxShadow={{ default: '0 2px 8px #0003', hover: '0 4px 16px #0004' }}
...
<MDXTabs id="flat-values-transforms" defaultValue="styled">
<MDXTabs.List>
  <MDXTabs.Tab value="styled">Typed</MDXTabs.Tab>
  <MDXTabs.Tab value="string">String</MDXTabs.Tab>
</MDXTabs.List>
...
```tsx
<html.div
  scale={{ default: 1, hover: 1.05 }}
  rotate={{ default: '0deg', hover: '5deg' }}
/>
```
...
```tsx
<html.div scale="1 hover:1.05" rotate="0deg hover:5deg" />
```
...
```tsx
<html.div width="size.4" color="color.blue-500" />
```
...
<MDXTabs id="flat-values-merging" defaultValue="styled">
<MDXTabs.List>
  <MDXTabs.Tab value="styled">Typed</MDXTabs.Tab>
  <MDXTabs.Tab value="string">String</MDXTabs.Tab>
</MDXTabs.List>
...
```tsx
<html.div backgroundColor={{ default: 'gray', hover: 'blue' }} bg="red" />
// backgroundColor is red; hover is blue

<html.div p={{ default: '4', sm: '6' }} px="2" />
...
<MDXTabs id="flat-values-groups" defaultValue="styled">
<MDXTabs.List>
  <MDXTabs.Tab value="styled">Typed</MDXTabs.Tab>
  <MDXTabs.Tab value="string">String</MDXTabs.Tab>
</MDXTabs.List>
...
```tsx
<html.div group>
  <html.span color={{ default: 'gray', 'group-hover': 'black' }} />
</html.div>

<html.div container>
  <html.span width={{ default: '100%', '@sm': '50%' }} />
</html.div>

<html.div group="card" container="card">
  <html.span color={{ default: 'gray', '@sm/card:group-hover/card': 'black' }} />
</html.div>
```
...
token spellings and V2 condition objects, rewrites every statically eligible site,
...
restore a V2 condition-object parser.
