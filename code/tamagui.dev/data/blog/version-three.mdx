...
<Notice>
  ...
  <CopyAgentSetupButton type="upgrade" mt="2" />
</Notice>
...
use a few dozen of its ~1700 icons. Generate only the icons you use with the
[Lucide Icons setup](/ui/lucide-icons) script instead.
...
Copy the agent prompt to make the agent stop at the codemod report instead of
writing straight through it:

<CopyAgentSetupButton type="upgrade" my="2" />

If you are doing it by hand, start with the [v3 upgrade guide](/docs/guides/how-to-upgrade). It has the
