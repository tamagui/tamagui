...
<IntroParagraph large>
  Tamagui bring high performing, highly consistent, typed inline styles to React
  Native and React Web, a large UI Kit, and a novel theme system and optimizing
  compiler.
</IntroParagraph>
