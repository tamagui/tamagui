...
<IntroParagraph large>
  Tamagui brings high performing, consistent, typed inline styles to React
  Native and React Web, plus composable UI components, a novel theme system and
...
and includes a few new features and components. It does simplify a few component
API surfaces.
