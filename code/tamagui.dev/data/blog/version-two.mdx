...
Tamagui's portal-based components (Sheet, Dialog, Popover, Select, Tooltip, and
Toast) now support true native portals via
[react-native-teleport](https://github.com/nicksrandall/react-native-teleport).

The problem: on native, the default Gorhom portal implementation doesn't
preserve React context. This means providers like theme, navigation, or your own
custom context aren't available inside portaled content - a major pain point
