...
- Removed `onHoverIn` and `onHoverOut` in favor of standard `onMouseEnter` and `onMouseLeave`.
- Added comprehensive web event handler support including keyboard, pointer, drag and drop, clipboard, and scroll events.
