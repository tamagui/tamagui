...
<IntroParagraph large>
  Tamagui is the secret to great universal React Native and Web style and UI.
  Its partial-evaluation optimizing compiler lets you write easy, fast, typed
  inline styles while outputting perfect platform-native code.
</IntroParagraph>

We're excited to announce that **the first release candidate for Tamagui v2 is
here**!

We'll do a little housekeeping first, but if you want to,
