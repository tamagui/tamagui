...
export const SocialLinksRow = () => {
  return (
    <XStack gap="$4" $sm={{ flexDirection: 'column' }}>
      <Link asChild href="https://x.com/tamagui_js" target="_blank" rel="noopener noreferrer">
        <Card
          width="33.33%"
          jc="center"
          $sm={{ width: 'auto' }}
      ...
      <Link asChild href="https://discord.gg/4qh6tdcVDa" target="_blank" rel="noopener noreferrer">
        <Card
          width="33.33%"
          jc="center"
          gap="$2"
      ...
      <Link asChild href="https://github.com/tamagui/tamagui" target="_blank" rel="noopener noreferrer">
        <Card
          width="33.33%"
          jc="center"
          $sm={{ width: 'auto' }}
