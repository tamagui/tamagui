      ...
      steps={[
        <>
          <NoticeParagraph key={0}>
            ...
            switch or button, you can customize those along with all the other components on step
            three.
          </NoticeParagraph>
        ...
        <>
          ...
          <NoticeParagraph key={4}>
            ...
            whole look and feel of an area, or use the one-off accent as needed.
          </NoticeParagraph>
        </>,
      ]}
    />
