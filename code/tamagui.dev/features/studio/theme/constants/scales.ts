...
export function getScalePreset<Name extends ScaleTypeName>(a: Name): (typeof scaleTypes)[Name] {
  return scaleTypes[a]
}
...
export const scaleTypes = {
  ...
  radix: {
    ...
    createdFrom: 'radix',
    lumScale: {
      light: [0.992, 0.95, 0.92, 0.868, 0.832, 0.804, 0.747, 0.659, 0.541, 0.453, 0.27, 0.086],
      dark: [0.07, 0.11, 0.136, 0.158, 0.179, 0.205, 0.243, 0.313, 0.439, 0.52, 0.61, 0.93],
    },
    satScale: {
  ...
  'radix-b': {
    ...
    createdFrom: 'radix-b',
    lumScale: {
      light: [0.92, 0.868, 0.832, 0.804, 0.747, 0.7, 0.659, 0.541, 0.453, 0.36, 0.32, 0.27],
      dark: [0.11, 0.136, 0.158, 0.179, 0.205, 0.243, 0.313, 0.439, 0.47, 0.52, 0.56, 0.61],
    },
    satScale: {
      light: [0.65, 0.55, 0.4, 0.4, 0.35, 0.35, 0.35, 0.35, 0.4, 0.4, 0.3, 0.2],
      dark: [0.65, 0.55, 0.4, 0.4, 0.35, 0.35, 0.35, 0.35, 0.4, 0.4, 0.3, 0.2],
  ...
  neon: {
    ...
    createdFrom: 'neon',
    lumScale: {
      light: [0.978, 0.938, 0.902, 0.868, 0.832, 0.804, 0.747, 0.659, 0.541, 0.453, 0.27, 0.086],
      dark: [0.07, 0.11, 0.136, 0.158, 0.179, 0.205, 0.243, 0.313, 0.439, 0.52, 0.61, 0.93],
    },
    satScale: {
      light: [0.65, 0.55, 0.4, 0.4, 0.35, 0.35, 0.35, 0.35, 0.4, 0.4, 0.3, 0.2],
  ...
  pastel: {
    ...
    createdFrom: 'pastel',
    lumScale: {
      light: [0.978, 0.938, 0.902, 0.868, 0.832, 0.804, 0.747, 0.659, 0.541, 0.453, 0.36, 0.2],
  ...
  'pastel-desaturating': {
    ...
    lumScale: {
      light: [0.935, 0.838, 0.802, 0.768, 0.732, 0.704, 0.647, 0.559, 0.441, 0.353, 0.17, 0],
