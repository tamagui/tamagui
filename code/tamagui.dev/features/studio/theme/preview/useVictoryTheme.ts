...
export const useVictoryTheme = (): VictoryThemeDefinition => {
  ...
  const color3Val = getVariableValue(theme['color-3'])
  const color5Val = getVariableValue(theme['color-5'])
  const color6Val = getVariableValue(theme['color-6'])
  const color8Val = getVariableValue(theme['color-8'])
  const color9Val = getVariableValue(theme['color-9'])
  const accent3Val = getVariableValue(theme['accent-3'])
  const accent6Val = getVariableValue(theme['accent-6'])
  const pink9Val = getVariableValue(theme['pink-9'])
  const red9Val = getVariableValue(theme['red-9'])
