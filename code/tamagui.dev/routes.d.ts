...
declare module 'one' {
  export namespace OneRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      StaticRoutes: `/` | `/(blog)` | `/(blog)/blog` | `/(blog)/draft` | `/(docs)` | `/(site)` | `/(site)/` | `/(site)/(blog)` | `/(site)/(blog)/blog` | `/(site)/(blog)/draft` | `/(site)/(docs)` | `/(site)/bento` | `/(site)/bento/(home)` | `/(site)/blog` | `/(site)/chat` | `/(site)/community` | `/(site)/dpa` | `/(site)/draft` | `/(site)/payment-finished` | `/(site)/privacy` | `/(site)/pro-license` | `/(site)/pro-policy` | `/(site)/studio` | `/(site)/takeout` | `/(site)/theme` | `/_sitemap` | `/admin` | `/admin/user` | `/auth` | `/bento` | `/bento/(home)` | `/blog` | `/chat` | `/community` | `/dpa` | `/draft` | `/invoice` | `/login` | `/payment-finished` | `/privacy` | `/pro-license` | `/pro-policy` | `/responsive-demo` | `/sandbox` | `/sandbox2` | `/studio` | `/takeout` | `/talk` | `/test` | `/theme`
