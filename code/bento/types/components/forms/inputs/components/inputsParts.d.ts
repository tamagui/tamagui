...
export declare const InputLabel: import("tamagui").TamaguiComponent<import("@tamagui/web").TamaDefer, HTMLButtonElement | import("react-native").View, import("@tamagui/web").TamaguiComponentPropsBaseBase & Omit<import("tamagui").TextNonStyleProps, "size" | "unstyled" | keyof import("@tamagui/web").TextStylePropsBase> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
    ...
    htmlFor?: string;
} & import("react").RefAttributes<HTMLButtonElement | import("react-native").View>, import("@tamagui/web").StackStyleBase, {
...
export declare const Input: import("react").ForwardRefExoticComponent<Omit<import("@tamagui/core").RNTamaguiViewNonStyleProps, "color" | "size" | keyof import("@tamagui/web").StackStyleBase | "gapScale"> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").StackStyleBase> & {
    ...
    Label: import("tamagui").TamaguiComponent<import("@tamagui/web").TamaDefer, HTMLButtonElement | import("react-native").View, import("@tamagui/web").TamaguiComponentPropsBaseBase & Omit<import("tamagui").TextNonStyleProps, "size" | "unstyled" | keyof import("@tamagui/web").TextStylePropsBase> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
        unstyled?: boolean | undefined;
        size?: number | `$${string}` | `$${number}` | `$${string}.${string}` | `$${string}.${number}` | import("@tamagui/web").UnionableNumber | import("@tamagui/web").UnionableString | undefined;
    } & import("@tamagui/web").WithShorthands<import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase>> & import("@tamagui/web").WithPseudoProps<import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
        unstyled?: boolean | undefined;
