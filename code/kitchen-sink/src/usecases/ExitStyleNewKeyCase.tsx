...
// regression: a style key first introduced by exit clause (no base value, never
...
// key set, so an element whose exit clause only used new keys unmounted the same
