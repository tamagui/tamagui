...
export function GroupPressInVariant() {
  return (
    <YStack gap="4" padding="4">
      ...
      <YStack group backgroundColor="gray-200" padding="4" id="test-unnamed-group">
      ...
      <YStack group backgroundColor="gray-200" padding="4" id="test-root-group">
      ...
      <YStack group backgroundColor="gray-200" padding="4" id="test-secondary-group">
