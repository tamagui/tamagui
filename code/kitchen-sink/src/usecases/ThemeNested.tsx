...
export function ThemeNested() {
  return (
    <YStack gap="4" padding="4">
      ...
      <YStack gap="2">
        <Text fontWeight="bold">Case 1: Direct light_blue_level3</Text>
      ...
      <YStack gap="2">
        <Text fontWeight="bold">Case 3: Nested light → blue → level3</Text>
        <Theme name="light">
          <Theme name="blue">
            <Theme name="level3">
      ...
      <YStack gap="2">
        <Text fontWeight="bold">Case 4: Direct light_red_level2</Text>
      ...
      <YStack gap="2">
        <Text fontWeight="bold">Case 5: Nested red → level2 (should match Case 4)</Text>
        <Theme name="red">
          <Theme name="level2">
      ...
      <YStack gap="2">
        <Text fontWeight="bold">Case 6: Direct light_level3 (no color - baseline)</Text>
        <Theme name="light_level3">
      ...
      <YStack gap="2">
        <Text fontWeight="bold">
          Case 8: Nested blue → level2 → level2 (should match Case 7)
        </Text>
        <Theme name="blue">
          <Theme name="level2">
            <Theme name="level2">
              <Square id={TEST_IDS.nestedLevel3Composed} bg="background" size={100} />
            </Theme>
          </Theme>
        </Theme>
      </YStack>
