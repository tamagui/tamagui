    ...
    <YStack gap="4" padding="4">
      ...
      <XStack gap="2">
        ...
        <View
          ...
          backgroundColor="customBlue/75"
          width={100}
          height={100}
        />
        <View
          data-testid="opacity-bg-green-25"
          backgroundColor="customGreen/25"
          width={100}
          height={100}
        />
      </XStack>
      ...
      <View data-testid="opacity-text-container">
        <Text data-testid="opacity-text" color="customRed/50" fontSize="6">
          50% red text
        </Text>
      </View>
      ...
      <View
        ...
        backgroundColor="customBlue/100 hover:customBlue/50"
        width={100}
        height={100}
      />
