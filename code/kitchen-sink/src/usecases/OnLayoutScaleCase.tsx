 ...
 *
 * when a CSS scale transform is applied, getBoundingClientRect()
  ...
  return (
    <YStack gap="4" padding="4">
      ...
      <Text testID="layout-no-scale">
        No Scale:{' '}
        {layoutWithoutScale
          ? `${layoutWithoutScale.width}x${layoutWithoutScale.height}`
          : 'waiting...'}
      </Text>
      ...
      <Text testID="layout-with-scale">
        With Scale:{' '}
        {layoutWithScale
          ? `${layoutWithScale.width}x${layoutWithScale.height}`
          : 'waiting...'}
      </Text>
      ...
      {/* debug info */}
      <YStack gap="2">
        <Text fontSize="3" color="gray-600">
