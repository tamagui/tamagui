...
function ActiveTextNoOpt({
  ...
  return <YStack disableOptimization testID="noopt-color-box" backgroundColor={isActive ? '$color12' : '$color11'} height={60} justifyContent="center" alignItems="center">
      <Text disableOptimization testID="active-text-noopt" fontSize="$3" fontWeight={isActive ? '700' : '400'} color={isActive ? '$color12' : '$color11'}>
        {label}
      </Text>
    </YStack>;
}
export function CompilerTernaryActive() {
  ...
  return <_ReactNativeViewStyled2 testID={"compiler-ternary-active-root"}>
...
const _ReactNativeViewStyled0 = _withStableStyle(__ReactNativeView, (theme, _expressions) => [_sheet["0"], _expressions[0] ? {
  "backgroundColor": theme.color12.get()
} : {
  "backgroundColor": theme.color11.get()
}], true, false);
const _ReactNativeTextStyled1 = _withStableStyle(__ReactNativeText, (theme, _expressions) => [_sheet["1"], {
  "color": theme.color.get()
}, _expressions[0] ? [_sheet["2"], {
  "color": theme.color12.get()
}] : [_sheet["3"], {
  "color": theme.color11.get()
}]], true, false);
const _ReactNativeViewStyled2 = _withStableStyle(__ReactNativeView, (theme, _expressions) => [_sheet["4"], {
  "backgroundColor": theme.background.get()
}], true, false);
const _ReactNativeTextStyled3 = _withStableStyle(__ReactNativeText, (theme, _expressions) => [_sheet["5"], {
  "color": theme.color.get()
}], true, false);
const _ReactNativeTextStyled4 = _withStableStyle(__ReactNativeText, (theme, _expressions) => [_sheet["7"], {
  "color": theme.color.get()
}], true, false);
const _ReactNativeTextStyled5 = _withStableStyle(__ReactNativeText, (theme, _expressions) => [_sheet["9"], {
  "color": theme.color.get()
}], true, false);