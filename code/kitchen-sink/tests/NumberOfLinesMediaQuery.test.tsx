...
test('numberOfLines in $web truncates to 1 line', async ({ page }) => {
...
test('numberOfLines=2 in $web applies line clamping', async ({ page }) => {
...
test('numberOfLines in $web matches top-level behavior', async ({ page }) => {
