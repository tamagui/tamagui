...
import { getComputedTranslateX, setupPage } from './test-utils'
...
test.describe('Transform Media Query Merge', () => {
  ...
  test('viewport resize updates transform correctly', async ({ page }) => {
    ...
    let x1 = await getComputedTranslateX(page, '[data-testid="test1"]')
    ...
    x1 = await getComputedTranslateX(page, '[data-testid="test1"]')
