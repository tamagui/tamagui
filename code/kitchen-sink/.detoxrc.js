...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      binaryPath: process.env.DETOX_IOS_APP_PATH || 'ios/build/Build/Products/Debug-iphonesimulator/tamaguikitchensink.app',
      build: 'xcodebuild -workspace ios/tamaguikitchensink.xcworkspace -scheme tamaguikitchensink -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath: process.env.DETOX_IOS_APP_PATH || 'ios/build/Build/Products/Release-iphonesimulator/tamaguikitchensink.app',
      build: 'xcodebuild -workspace ios/tamaguikitchensink.xcworkspace -scheme tamaguikitchensink -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
