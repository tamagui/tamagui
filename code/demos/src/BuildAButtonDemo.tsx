import { Drumstick, Hand } from '@tamagui/local-icons'
  ...
  return (
    <YStack position="absolute" inset={0} overflow="hidden">
      <XStack maxH={200} y={-100} x={-40} rotate="-10deg">
        <ButtonCol y={35} size="xs" {...outlined} subTheme="level2" borderWidth={1} />
        <ButtonCol y={30} />
        <ButtonCol y={-50} {...outlined} />
        <ButtonCol {...outlined} icon={<Hand />} />
        <ButtonCol size="xl" subTheme="level3" />
        <ButtonCol size="xl" subTheme="level3" {...outlined} />
        <ButtonCol size="xl" subTheme="level3" iconAfter={<Drumstick />} {...outlined} />
        <ButtonCol size="xl" subTheme="level2" />
        <ButtonCol size="xl" subTheme="level3" {...outlined} rounded={0} />
      </XStack>
    </YStack>
  )
}
