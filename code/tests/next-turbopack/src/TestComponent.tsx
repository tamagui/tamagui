...
export function TestComponent() {
  ...
  return (
    <YStack
            flex={1} justifyContent="center" alignItems="center" gap="$4" padding="$4" backgroundColor="$background"
          >
      ...
      <YStack
                  padding="$4" backgroundColor="$blue5" borderRadius="$4" $sm={{ backgroundColor: '$red5' }}
                >
