/**
 * Type tests for styleMode: 'tamagui' (classic ONLY, default mode)
 *
 * In this mode:
...
describe('tamagui-only mode - POSITIVE tests (classic style props should work)', () => {
...
describe('tamagui-only mode - POSITIVE tests (shorthands should work)', () => {
...
describe('tamagui-only mode - POSITIVE tests (object pseudo/media should work)', () => {
...
describe('tamagui-only mode - POSITIVE tests (base props should work)', () => {
...
describe('tamagui-only mode - NEGATIVE tests (flat props should NOT exist)', () => {
...
describe('tamagui-only mode - styled() components', () => {
...
describe('tamagui-only mode - JSX usage compile tests', () => {
  ...
  // NOTE: These should be compile errors in tamagui-only mode:
  // @ts-expect-error - $bg should not be allowed in tamagui-only mode
