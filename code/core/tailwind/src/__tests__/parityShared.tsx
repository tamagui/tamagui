...
const SAMPLE: Record<string, { comp: any; attr: string } | null> = {
  ...
  paddingInlineStart: { comp: View, attr: 'paddingInlineStart={10}' },
  paddingInlineEnd: { comp: View, attr: 'paddingInlineEnd={10}' },
  paddingBlockStart: { comp: View, attr: 'paddingBlockStart={10}' },
  paddingBlockEnd: { comp: View, attr: 'paddingBlockEnd={10}' },
  ...
  marginInlineStart: { comp: View, attr: 'marginInlineStart={8}' },
  marginInlineEnd: { comp: View, attr: 'marginInlineEnd={8}' },
  marginBlockStart: { comp: View, attr: 'marginBlockStart={8}' },
  marginBlockEnd: { comp: View, attr: 'marginBlockEnd={8}' },
  marginHorizontal: { comp: View, attr: 'marginHorizontal={8}' },
  marginVertical: { comp: View, attr: 'marginVertical={8}' },
  gap: { comp: View, attr: 'gap={8}' },
  columnGap: { comp: View, attr: 'columnGap={8}' },
  rowGap: { comp: View, attr: 'rowGap={8}' },
  ...
  borderInlineStartWidth: { comp: View, attr: 'borderInlineStartWidth={2}' },
  borderInlineEndWidth: { comp: View, attr: 'borderInlineEndWidth={2}' },
  borderBlockStartWidth: { comp: View, attr: 'borderBlockStartWidth={2}' },
  borderBlockEndWidth: { comp: View, attr: 'borderBlockEndWidth={2}' },
  ...
  borderInlineStartColor: { comp: View, attr: 'borderInlineStartColor="red"' },
  borderInlineEndColor: { comp: View, attr: 'borderInlineEndColor="red"' },
  borderBlockStartColor: { comp: View, attr: 'borderBlockStartColor="red"' },
  borderBlockEndColor: { comp: View, attr: 'borderBlockEndColor="red"' },
  ...
  borderStartStartRadius: { comp: View, attr: 'borderStartStartRadius={12}' },
  borderStartEndRadius: { comp: View, attr: 'borderStartEndRadius={12}' },
  borderEndStartRadius: { comp: View, attr: 'borderEndStartRadius={12}' },
  borderEndEndRadius: { comp: View, attr: 'borderEndEndRadius={12}' },
  borderStyle: { comp: View, attr: 'borderStyle="dashed"' },
  outlineWidth: { comp: View, attr: 'outlineWidth={2}' },
  outlineColor: { comp: View, attr: 'outlineColor="red"' },
  outlineStyle: { comp: View, attr: 'outlineStyle="dashed"' },
  outlineOffset: { comp: View, attr: 'outlineOffset={2}' },
