...
export declare function createThemes<ComponentThemes extends SimpleThemeDefinitions, SubThemes extends Record<string, ColorDefs>>({ base, accent, subThemes, componentThemes, }: {
    base: ColorDefs;
    accent: ColorDefs;
    subThemes?: SubThemes;
