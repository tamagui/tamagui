import { type GetThemeContext, type ThemeDefinitionContext, type ThemeInputValue } from '@tamagui/create-theme';
...
export declare const shadows: {
    readonly light: {
        readonly 'shadow-1': 'rgba(0, 0, 0, 0.03)';
        readonly 'shadow-2': 'rgba(0, 0, 0, 0.06)';
        readonly 'shadow-3': 'rgba(0, 0, 0, 0.1)';
        readonly 'shadow-4': 'rgba(0, 0, 0, 0.17)';
        readonly 'shadow-5': 'rgba(0, 0, 0, 0.26)';
        readonly 'shadow-6': 'rgba(0, 0, 0, 0.36)';
        readonly 'shadow-7': 'rgba(0, 0, 0, 0.5)';
    };
    readonly dark: {
...
export declare function getTheme({ recipe, tokens: themeTokens, }: GetThemeContext<typeof tokens, DefaultRecipe> | GetThemeContext<{
    color: Record<string, string>;
}, PaletteRecipe>): Record<keyof Ramp | SemanticThemeKey | ShadowName, ThemeInputValue<typeof tokens>>;
