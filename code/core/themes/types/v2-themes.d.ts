...
export declare const maskOptions: {
    component: {
        ...
        palette?: import("@tamagui/theme-builder").CreateThemePalette;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        overrideShift?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
    ...
    alt: {
        palette?: import("@tamagui/theme-builder").CreateThemePalette;
        override?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        overrideShift?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        skip?: Partial<import("@tamagui/theme-builder").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
