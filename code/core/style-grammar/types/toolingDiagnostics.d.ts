...
import { type PayloadShapeDiagnostic } from "./payloadShape";
import { type PayloadResolveErrorCode, type ReferenceKind } from "./resolvePayload";
import { type ValueSourceSpan } from "./valueParser";
