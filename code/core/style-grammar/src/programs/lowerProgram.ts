...
import { parseGroupModifier } from '../runtime/clauseIdentity'
...
import { transformAxisCompositions } from '../shorthands/transformFamily'
import { programClassName } from './programHash'
import type { LonghandProgram, ModifierRegistryView } from '../ast/valueTypes'
...
export const defaultStateSelectors: Readonly<Record<string, ConditionSelector>> =
  Object.freeze({
    ...
    disabled: { fragment: '[aria-disabled="true"]' },
