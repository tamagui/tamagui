...
export interface DocumentStyleTooling {
	...
	diagnostics(source: string, fileName?: string, options?: DocumentDiagnosticOptions): readonly DocumentDiagnostic[];
...
export declare function createDocumentStyleTooling(tooling: StyleTooling, extract: ExtractStyleSites, toolingOptions?: DocumentStyleToolingOptions): DocumentStyleTooling;
