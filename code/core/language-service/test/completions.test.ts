  ...
  test('reports flat value diagnostics with exact spans', () => {
    ...
    expect(spans).toEqual([
      ...
      },
      {
        code: 78711,
        message:
          '"blue" contributes to "backgroundColor", "borderColor", "borderTopColor", "borderRightColor", "borderBottomColor", "borderLeftColor", "borderInlineStartColor", "borderInlineEndColor", "borderBlockStartColor", "borderBlockEndColor", "color", not "padding"',
        text: 'blue',
      },
    ])
    fixture.service.dispose()
