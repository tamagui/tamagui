...
export const COMPATIBILITY: readonly CompatibilityRow[] = [
  ...
  },
  {
    ...
    rsd: 'breaks long words inside headings on web',
    tamagui: 'breaks long words inside inline text only',
    reason:
      'a heading is a block like any other; singling it out for a different overflow rule is not something native can match',
  },
  {
    area: 'style',
