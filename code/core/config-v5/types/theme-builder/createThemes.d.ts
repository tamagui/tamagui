import type { Template } from '../create-theme';
 ...
 */
export declare function createV4Themes<Extra extends ExtraThemeValuesByScheme = ExtraThemeValuesByScheme, SubThemes extends SimpleThemesDefinition = SimpleThemesDefinition, ComponentThemes extends SimpleThemesDefinition | false = SimpleThemesDefinition, GrandChildrenThemes extends SimpleThemesDefinition | undefined = undefined, Accent extends BaseThemeDefinition<Extra> | undefined = undefined, Templates extends BuildTemplates = typeof defaultTemplates, GetThemeReturn extends Record<string, string | number> = Record<string, string>>(props: CreateThemesProps<Accent, GrandChildrenThemes, Extra, SubThemes, ComponentThemes, Templates, GetThemeReturn>): Record<"dark" | "light" | ((Accent extends undefined ? false : true) extends infer T ? T extends (Accent extends undefined ? false : true) ? T extends true ? "dark_accent" | "light_accent" : never : never : never) | (keyof SubThemes extends string ? `dark_${(GrandChildrenThemes extends undefined ? undefined : Record<keyof GrandChildrenThemes, any>) extends infer T_1 ? T_1 extends (GrandChildrenThemes extends undefined ? undefined : Record<keyof GrandChildrenThemes, any>) ? T_1 extends undefined ? string & keyof SubThemes : NamesWithChildrenNames<string & keyof SubThemes, keyof T_1> : never : never}` | `light_${(GrandChildrenThemes extends undefined ? undefined : Record<keyof GrandChildrenThemes, any>) extends infer T_1 ? T_1 extends (GrandChildrenThemes extends undefined ? undefined : Record<keyof GrandChildrenThemes, any>) ? T_1 extends undefined ? string & keyof SubThemes : NamesWithChildrenNames<string & keyof SubThemes, keyof T_1> : never : never}` : never), { [ThemeKey in "accentBackground" | "accentColor" | "background" | "background0" | "background02" | "background04" | "background06" | "background08" | "backgroundFocus" | "backgroundHover" | "backgroundPress" | "borderColor" | "borderColorFocus" | "borderColorHover" | "borderColorPress" | "color" | "color0" | "color02" | "color04" | "color06" | "color08" | "color1" | "color10" | "color11" | "color12" | "color2" | "color3" | "color4" | "color5" | "color6" | "color7" | "color8" | "color9" | "colorFocus" | "colorHover" | "colorPress" | "colorTransparent" | "outlineColor" | "placeholderColor" | keyof Extra["dark"] | ((Accent extends undefined ? false : true) extends infer T_2 ? T_2 extends (Accent extends undefined ? false : true) ? T_2 extends true ? "accent0" | "accent1" | "accent10" | "accent11" | "accent12" | "accent2" | "accent3" | "accent4" | "accent5" | "accent6" | "accent7" | "accent8" | "accent9" : never : never : never)]: string; } & GetThemeReturn>;
