...
// native twin of sizingV5.web.test.tsx: pinned geometry is platform-invariant
// even though v5's own font scales are not.
...
test('v5 rungs use v5 keys with pinned geometry', () => {
  expect(resolveSizing('md', env)).toMatchObject({
    name: 'md',
    fontSize: '3',
    height: 36,
    icon: 16,
...
test('v5 geometry matches the frozen ladder on native too', () => {
