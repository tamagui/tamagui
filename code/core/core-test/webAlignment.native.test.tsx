...
// TODO: Event mapping tests to be added back
// - onClick → onPress mapping
// - onPointerDown → onPressIn mapping
// - onPointerUp → onPressOut mapping

// TODO: Shadow props tests to be added back when boxShadow is fully integrated
// - boxShadow should work on native (RN 0.76+)
// - Legacy shadow props (shadowColor, shadowOffset, etc.) should be deprecated
