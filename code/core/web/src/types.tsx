...
export type GetStyleState = {
  ...
  // dev-tools token provenance: original token string (like '$background') for
  // each winning base style key, cleared on literal override. stamped onto the
  // final style object as non-enumerable metadata (see helpers/styleProvenance).
