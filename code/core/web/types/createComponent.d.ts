...
import type { DebugProp, SpaceDirection, SpacerProps, SpacerStyleProps, SpaceValue, StackNonStyleProps, StaticConfig, TamaguiComponent, TamaguiComponentState, TamaguiElement } from './types';
