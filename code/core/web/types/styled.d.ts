...
import type { GetBaseStyles, GetNonStyledProps, GetStaticConfig, GetStyledVariants, GetVariantValues, InferStyledProps, StaticConfigPublic, StylableComponent, StyledContext, TamaDefer, TamaguiComponent, TextStylePropsBase, ThemeValueGet, VariantDefinitions, VariantSpreadFunction, WithThemeShorthandsPseudosMedia } from './types';
