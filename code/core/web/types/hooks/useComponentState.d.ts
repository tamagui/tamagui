import { type GenericProps } from '../helpers/mergeProps';
...
export declare const useComponentState: (caller: ViewProps | TextProps | Record<string, any>, styledContextValue: GenericProps | undefined, resolvedDefaultProps: Record<string, any> | undefined, animationDriver: ComponentContextI['animationDriver'], staticConfig: StaticConfig, config: TamaguiInternalConfig) => {
