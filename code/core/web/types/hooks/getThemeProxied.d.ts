...
import type { ThemeParsed, ThemeState, Tokens, UseThemeWithStateProps, Variable, VariableVal, VariableValGeneric } from '../types';
...
export declare function getThemeUntracked(_state: ThemeState | null): ThemeProxied;
export declare function getThemeProxied(_props: UseThemeWithStateProps, _state: ThemeState | null, _keys: MutableRefObject<Set<string> | null>, _schemeKeys?: MutableRefObject<Set<string> | null>): ThemeProxied;
export {};
