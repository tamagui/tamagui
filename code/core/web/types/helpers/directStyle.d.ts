...
export declare function directStyleSignature(
  property: string,
  value: unknown,
  conditionKey?: string
): string
export declare function flushDirectStyles(state: GetStyleState, clear?: boolean): void
export declare function getDirectDynamicThemeAccess(
  state: GetStyleState
): boolean | undefined
export declare function contributeStyleString(
  state: GetStyleState,
  property: string,
  source: string,
  merge: MergeStyle,
...
export declare function contributeFrontendValue(
  state: GetStyleState,
  property: string,
  value: ParsedValue,
  merge: MergeStyle,
...
export declare function contributeVariantClauseValue(
  state: GetStyleState,
  property: string,
  value: any,
...
export declare function contributeStyleValue(
  state: GetStyleState,
  property: string,
  value: any,
  merge: MergeStyle,
