...
export declare function resolveVariantCondition(state: GetStyleState, text: string, parent?: unknown): Condition;
export declare function isVariantConditionValid(condition: unknown): boolean;
