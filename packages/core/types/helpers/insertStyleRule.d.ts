...
export declare function updateInsertedCache(identifier: string, rule: string): void;
export declare function insertStyleRule(identifier: string, rule: string): string | undefined;
