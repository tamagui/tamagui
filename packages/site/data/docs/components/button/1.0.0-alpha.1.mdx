...
<Highlights
  features={[
    'Accepts theme and themeInverse props.',
    'Accepts size props to scale up and down.',
    'Places icons and ensures text is styled.',
    'Custom styles for disabled, active, chromeless.',
  ]}
/>
