...
Tamagui components are far more feature-rich than other styling libraries, so in the worst case where every component isn't extracted, you get middle-of-the-road performance. The good news is, this is a worst-case scenario, and we have a lot of low hanging fruit for improvement.
