...
We benchmarked NativeBase but the performance was far worse than the rest, which distorted the charts. We've left the numbers in text below.
...
> NativeBase: 0.73. Since styled-components and Emotion don't offer a first-class variant API, this was done via prop interpolation.
