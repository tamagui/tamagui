...
Work with your two favorite libraries: `react-native` and `react-native-web`. Tamagui improves their typical performance by introducing the compiler - especially with media queries, themes, and dynamic styles.
