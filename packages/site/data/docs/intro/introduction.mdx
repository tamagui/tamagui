...
Tamagui lets you **share more code between web and native apps while improving DX, performance, and accessibility**. It turns all styles, even inline styles with conditional logic or responsive queries or themes, into efficient extracted atomic CSS on the web, or on native, into an efficient top-level StyleSheet.
...
The compiler even flattens any fully analyzable views into a much faster simple HTML tags on web, or View/Text on native, reducing tree depth signficantly.
...
- [Modulz](https://github.com/modulz) for the bones of the website and base logic for some components.
- [Moti](https://moti.fyi) for the foundation of the reanimated driver.
- [Framer Motion](https://github.com/framer/motion) for the AnimatedPresence functionality.
