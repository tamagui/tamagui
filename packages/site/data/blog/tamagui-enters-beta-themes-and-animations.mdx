...
Since the first alpha it's been six months, [several hundreds of bugfixes](https://github.com/tamagui/tamagui/releases/tag/v1.0.0-beta.0), [three demo apps](https://github.com/tamagui), and a number of new core features. Plus, a totally [refreshed site](/), and a [benchmark suite](/docs/intro/benchmarks). a grip of type improvements, compatability fixes and internals speedups its' really shaped up to be interesting. There are two pieces though that are the biggest impact: **Animations**, and **Themes**.

---

## Overhauled Themes 🎨

Themes have been completely redone in an exciting way - they are a huge step forward, a the power and flexibility they have is really unparelleled. They are easier to use, map to styles you can use easily, and can build off alternative trees with uniqued shading, contrasts, and look. All of thi can be shared on `npm`.
...
We've released [@tamagui/feather-icons](/docs/components/feather-icons), which have numerous adjustmenets to make them work well with themes and automatically plug in on Native and Web.
