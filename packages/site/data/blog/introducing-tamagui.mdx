...
Until today, sharing code between native and web has had some big downsides — especially inline styling, responsive styling and themes. All of the above require time and memory-hungry operations in JavaScript. On the web, especially, this runs a lot of JS on the same thread as your layout, cuasing issues with jank and limitations rendering deeper trees.

**Tamagui introduces an optimizing compiler, enabling:**

### Inline styles without overhead

An optimizing compiler extracts most styles you write, for **2-3x speed improvements**. Even if they're inside conditional ternaries or spread objects, it extracts styles out of your JS bundle and into atomic CSS.
