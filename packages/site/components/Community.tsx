import { VStack, Box, Grid, Title, Text, Paragraph } from 'snackui'

export function Community() {
  return (
    <VStack size={{ '@initial': '2', '@bp1': '3' }}>
      <VStack size="2">
        <Title as="h3" size="lg" css={{ ta: 'center', mb: '$2' }}>
          Community
        </Title>
        ...
        <Grid itemMinWidth={120}>
          ...
          <Box>
            ...
            >
              ...
              <Text as="p" size="3" css={{ lineHeight: '23px', color: '$slate11' }}>
                Get involved with the community and get questions answered.
              </Text>
            </Box>
          </Box>
          <Box>
