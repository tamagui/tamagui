...
export declare const PopoverContent: React.ForwardRefExoticComponent<Pick<Omit<import("@tamagui/core/types").RNWInternalProps, "children"> & import("@tamagui/core/types").WithThemeValues<import("@tamagui/core/types").StackStylePropsBase> & {} & {
