export declare const Card: import("@tamagui/core").StaticComponent<Omit<Omit<Omit<import("@tamagui/core").StackProps, `$${string}` | keyof import("@tamagui/core").PseudoProps<any> | 1234556123312321> & {
