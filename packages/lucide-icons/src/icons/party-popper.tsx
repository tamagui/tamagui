...
const Icon = (props) => {
  ...
  return (
    <Svg
      ...
      {...otherProps}
    >
      <Path d="M5.8 11.3 2 22l10.7-3.79" fill="none" stroke={`${color}`} />
      <Path d="M4 3h.01" fill="none" stroke={`${color}`} />
      <Path d="M22 8h.01" fill="none" stroke={`${color}`} />
      <Path d="M15 2h.01" fill="none" stroke={`${color}`} />
      <Path d="M22 20h.01" fill="none" stroke={`${color}`} />
      <Path
