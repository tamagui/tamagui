  ...
  return (
    ...
    >
      <Path
        ...
        stroke={`${color}`}
      />
      <Path d="M16 8V5c0-1.1.9-2 2-2" fill="none" stroke={`${color}`} />
      <Path d="M12 13h4" fill="none" stroke={`${color}`} />
      <Path d="M12 18h6a2 2 0 0 1 2 2v1" fill="none" stroke={`${color}`} />
      <Path d="M12 8h8" fill="none" stroke={`${color}`} />
      <Path
