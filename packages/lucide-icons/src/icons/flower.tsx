...
const Icon = (props) => {
  ...
  return (
    ...
    >
      ...
      <Path d="m8 16 1.5-1.5" fill="none" stroke={`${color}`} />
      <Path d="M14.5 9.5 16 8" fill="none" stroke={`${color}`} />
      <Path d="m8 8 1.5 1.5" fill="none" stroke={`${color}`} />
      <Path d="M14.5 14.5 16 16" fill="none" stroke={`${color}`} />
    </Svg>
  )
}
