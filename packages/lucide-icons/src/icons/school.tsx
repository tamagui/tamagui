...
const Icon = (props) => {
  ...
  return (
    <Svg
      ...
      {...otherProps}
    >
      <Path d="m4 6 8-4 8 4" fill="none" stroke={`${color}`} />
      <Path
      ...
      <Path
        ...
        stroke={`${color}`}
      />
      <Path d="M18 5v17" fill="none" stroke={`${color}`} />
      <Path d="M6 5v17" fill="none" stroke={`${color}`} />
      <_Circle cx="12" cy="9" r="2" fill="none" stroke={`${color}`} />
    </Svg>
  )
}
