  ...
  return (
    ...
    >
      ...
      <Path
        ...
        stroke={`${color}`}
      />
      <Path d="M8.65 22c.21-.66.45-1.32.57-2" fill="none" stroke={`${color}`} />
      <Path
        d="M14 13.12c0 2.38 0 6.38-1 8.88"
        fill="none"
        stroke={`${color}`}
      />
      <Path d="M2 16h.01" fill="none" stroke={`${color}`} />
      <Path d="M21.8 16c.2-2 .131-5.354 0-6" fill="none" stroke={`${color}`} />
      <Path
