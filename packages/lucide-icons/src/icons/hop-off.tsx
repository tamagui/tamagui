  ...
  return (
    ...
    >
      ...
      <Path
        ...
        stroke={`${color}`}
      />
      <Path d="M17.5 17.5c-2.5 0-4 0-6-1" fill="none" stroke={`${color}`} />
      <Path d="M20 11.5c1 1.5 2 3.5 2 4.5" fill="none" stroke={`${color}`} />
      <Path
        d="M11.5 20c1.5 1 3.5 2 4.5 2 .5-1.5 0-3-.5-4.5"
        fill="none"
        stroke={`${color}`}
      />
      <Path d="M22 22c-2 0-3.5-.5-5.5-1.5" fill="none" stroke={`${color}`} />
      <Path
