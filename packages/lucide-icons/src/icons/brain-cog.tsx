  ...
  return (
    ...
    >
      <Path
        ...
        stroke={`${color}`}
      />
      <_Circle cx="12" cy="12" r="2" fill="none" stroke={`${color}`} />
      <Path d="M12 9v1" fill="none" stroke={`${color}`} />
      <Path d="M12 14v1" fill="none" stroke={`${color}`} />
      <Path d="m14.6 10.5-.87.5" fill="none" stroke={`${color}`} />
      <Path d="m10.27 13-.87.5" fill="none" stroke={`${color}`} />
      <Path d="m14.6 13.5-.87-.5" fill="none" stroke={`${color}`} />
      <Path d="m10.27 11-.87-.5" fill="none" stroke={`${color}`} />
    </Svg>
  )
}
