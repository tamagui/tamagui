...
export declare const ListItemText: import("@tamagui/core").TamaguiComponent<unknown, TamaguiElement, unknown, {}>;
export declare const ListItemSubtitle: import("@tamagui/core").TamaguiComponent<unknown, TamaguiElement, unknown, {}>;
export declare const ListItemTitle: import("@tamagui/core").TamaguiComponent<unknown, TamaguiElement, unknown, {}>;
export declare const useListItem: (props: ListItemProps, { Text, Subtitle, Title, }?: {
    ...
    props: {
        ...
        fontFamily: TextParentStyles;
    };
};
export declare const listItemStaticConfig: {
    inlineProps: Set<string>;
};
export declare const ListItem: ((props: Omit<Pick<ListItemProps, string | number | symbol> & React.RefAttributes<TamaguiElement>, "theme" | "themeInverse"> & ThemeableProps) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null) & {
    Text: import("@tamagui/core").TamaguiComponent<unknown, TamaguiElement, unknown, {}>;
    Subtitle: import("@tamagui/core").TamaguiComponent<unknown, TamaguiElement, unknown, {}>;
};
export {};
