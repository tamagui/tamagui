...
import { SizeTokens } from '@tamagui/web';
import { CreateTamaguiProps, GetProps, ThemeableProps } from '@tamagui/web';
...
export { Button, ButtonFrame, ButtonTextFrame as ButtonText, buttonStaticConfig, useButton, ButtonTextFrame, createButtonScope, };
