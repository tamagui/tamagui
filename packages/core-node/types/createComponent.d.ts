...
import { SpaceDirection, SpaceTokens, StaticConfig, StaticConfigParsed, StylableComponent, TamaguiComponent, TamaguiElement } from './types';
...
export declare const Spacer: TamaguiComponent<any, TamaguiElement, never, {}>;
