...
export declare type OmitLonghands<R extends Record<string, any>> = Longhands extends never ? R : TamaguiConfig['onlyAllowShorthands'] extends false ? R : Omit<R, Longhands>;
