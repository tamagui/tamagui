...
export declare const Switch: import("@tamagui/web").ReactComponentWithRef<Object & Omit<import("./createSwitch").SwitchProps, keyof Object>, any> & {
    staticConfig: import("@tamagui/web").StaticConfig;
    styleable: import("@tamagui/web").Styleable<import("./createSwitch").SwitchProps, any>;
} & {
