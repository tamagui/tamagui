...
import type { GetBaseStyles, GetNonStyledProps, GetStaticConfig, GetStyledVariants, GetTokenPropsFromAcceptedTokens, GetVariantValues, InferProps, StaticConfigPublic, StylableComponent, TamaguiComponent, VariantDefinitions, VariantSpreadFunction } from './types';
...
export declare function styled<ParentComponent extends StylableComponent, StyledStaticConfig extends StaticConfigPublic, Variants extends VariantDefinitions<ParentComponent, StyledStaticConfig>>(ComponentIn: ParentComponent, options?: Partial<InferProps<ParentComponent, StyledStaticConfig>> & {
    name?: string;
