...
>(staticConfig: StaticConfig) {
  ...
  const component = forwardRef<Ref, ComponentPropTypes>((propsIn: any, forwardedRef) => {
    ...
    // shouldnt avoidStyles still keep splitStylesStyle and just avoid animation?
    const styles = avoidStyle ? undefined : animationStyles || splitStylesStyle
