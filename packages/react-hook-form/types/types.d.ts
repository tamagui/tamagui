...
export type FormProps<TFieldValues extends FieldValues = FieldValues> = UseFormProps<TFieldValues> & Omit<FormDefaultProps, 'onSubmit'> & {
    onSubmit: SubmitHandler<TFieldValues>;
    fRef?: MutableRefObject<FRef<TFieldValues> | null>;
};
type ExtractStaticProps<El> = Omit<El, '$$typeof'>;
type ExtractWithController<TProps, TFieldValues extends FieldValues = FieldValues> = ReturnType<typeof withController<TProps, TFieldValues>>;
export type StaticProps<TFieldValues extends FieldValues = FieldValues> = {
    Input: ExtractWithController<InputProps, TFieldValues>;
    Checkbox: ExtractWithController<CheckboxProps, TFieldValues> & ExtractStaticProps<typeof Checkbox>;
    RadioGroup: ExtractWithController<RadioGroupProps, TFieldValues> & ExtractStaticProps<typeof RadioGroup>;
