...
export declare const SelectTrigger: React.ForwardRefExoticComponent<Pick<ButtonProps, string | number | symbol> & React.RefAttributes<GenericElement>>;
...
export declare const Select: ((props: ScopedProps<SelectProps>) => JSX.Element) & {
    ...
    Trigger: React.ForwardRefExoticComponent<Pick<ButtonProps, string | number | symbol> & React.RefAttributes<GenericElement>>;
