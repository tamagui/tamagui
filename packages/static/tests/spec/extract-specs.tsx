...
import { AbsoluteYStack, Box, Spacer, Text, YStack, useMedia } from 'tamagui'
...
export function TestMediaQuery() {
  ...
  return (
    <>
      ...
      <YStack borderRightWidth={media2.xs && nonStaticInt ? 1 : 0} borderLeftWidth={media3.sm ? 1 : 0}>
        {media3.lg && <div />}
      </YStack> */}
...
//   return (
//     <AbsoluteYStack fullscreen position="relative">
//       <AbsoluteYStack {...baseStyle}>
//         <AbsoluteYStack fullscreen position="relative" {...nestedStyle} />
//       </AbsoluteYStack>
//     </AbsoluteYStack>
//   )
// }
