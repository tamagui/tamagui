...
describe('exports/createElement', () => {
  ...
  describe('accessibility props', () => {
    ...
    test('accessibilityColumnSpan', () => {
      const { container: isEmpty } = render(createElement('div', { accessibilityColumnSpan: null }))
    ...
    test('accessibilityControls', () => {
      ...
      const { container: hasValue } = render(createElement('div', { accessibilityControls: 'abc' }))
    ...
    test('accessibilityCurrent', () => {
      ...
      const { container: hasValue } = render(createElement('div', { accessibilityCurrent: 'page' }))
    ...
    test('accessibilityInvalid', () => {
      ...
      const { container: hasValue } = render(createElement('input', { accessibilityInvalid: true }))
    ...
    test('accessibilityLabelledBy', () => {
      const { container: isEmpty } = render(createElement('div', { accessibilityLabelledBy: null }))
    ...
    test('accessibilityLiveRegion', () => {
      const { container: isEmpty } = render(createElement('div', { accessibilityLiveRegion: null }))
    ...
    test('accessibilityMultiline', () => {
      ...
      const { container: hasValue } = render(createElement('div', { accessibilityMultiline: true }))
    ...
    test('accessibilityReadOnly', () => {
      const { container: isEmpty } = render(createElement('input', { accessibilityReadOnly: null }))
    ...
    test('accessibilityRequired', () => {
      const { container: isEmpty } = render(createElement('input', { accessibilityRequired: null }))
