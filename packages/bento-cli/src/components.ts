...
export const componentsList: Omit<ComponentSchema, 'isOSS'>[] = [
  ...
  },
  {
    ...
    moveFilesToFolder: [{ file: 'SwitchCustomIcons', to: '' }, {file: 'switchParts', to: 'common'}],
  },
  {
  ...
  },
  {
    ...
    dependencies: ['@tamagui/lucide-icons'],
    moveFilesToFolder: [{ file: 'TopNavBarWithLogo', to: '' }, {file: 'Drawer', to: '../common'}],
  },
  {
    ...
    categorySection: 'navbars',
    dependencies: ['@tamagui/lucide-icons'],
    moveFilesToFolder: [{ file: 'TopNavBarWithUnderLineTabs', to: '' }, {file: 'Drawer', to: '../common'}],
  },
  {
    ...
    dependencies: ['@tamagui/lucide-icons', '@tamagui/roving-focus'],
    moveFilesToFolder: [{ file: 'FullSideBar', to: '' }, {file: 'Drawer', to: '../common'}],
  },
  {
