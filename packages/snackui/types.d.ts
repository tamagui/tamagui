...
declare module "snackui" {
    ...
    export type StackProps = Omit<RNWInternalProps, 'onLayout'> & EnhancedStyleProps & Omit<ViewProps, 'display' | 'onLayout'> & {
...
declare module "snackui" {
    ...
    export function fixNativeShadow(props: StackProps, merge?: boolean): StackProps;
}
