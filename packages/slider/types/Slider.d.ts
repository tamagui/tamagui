...
import type { ScopedProps, SliderProps, SliderTrackProps } from './types';
...
declare const Slider: React.ForwardRefExoticComponent<Omit<ScopedProps<SliderProps>, "ref"> & React.RefAttributes<unknown>> & {
