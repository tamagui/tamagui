...
;(function (global) {
  ...
  function registerSegment(segmentId, moduleDefiner, moduleIds) {
    ...
    if (__DEV__) {
      ...
      if (segmentId !== 0 && !moduleIds) {
        throw new Error(
          'registerSegment: Expected moduleIds to be passed for segment #' + segmentId
        )
      }
    }
    if (moduleIds) {
  ...
  function loadModuleImplementation(moduleId, module) {
    if (!module && moduleDefinersBySegmentID.length > 0) {
      ...
      var segmentId =
        (_definingSegmentByMod = definingSegmentByModuleID.get(moduleId)) !== null &&
        _definingSegmentByMod !== void 0
  ...
  if (__DEV__) {
    ...
    var metroHotUpdateModule = function metroHotUpdateModule(
      id,
      factory,
      dependencyMap,
      inverseDependencies
        ...
        updatedModuleIDs = topologicalSort(
          ...
          function (pendingID) {
            ...
            if (!canAccept && Refresh != null) {
              var isBoundary = isReactRefreshBoundary(
                Refresh,
        ...
        if (refreshBoundaryIDs.has(updatedID)) {
          ...
          if (isNoLongerABoundary || didInvalidate) {
            ...
            for (var j = 0; j < parentIDs.length; j++) {
              ...
              var canAcceptParent = isReactRefreshBoundary(
                Refresh,
    ...
    var shouldInvalidateReactRefreshBoundary =
      function shouldInvalidateReactRefreshBoundary(Refresh, prevExports, nextExports) {
    ...
    var getRefreshBoundarySignature = function getRefreshBoundarySignature(
      Refresh,
      moduleExports
    ) {
      var signature = []
    ...
    var registerExportsForReactRefresh = function registerExportsForReactRefresh(
      Refresh,
      moduleExports,
      moduleID
    ) {
...
__d(
  function (
    ...
    module.exports = _$$_REQUIRE(
      ...
      httpServerLocation: '/assets/@@/@@/packages/font-inter/otf',
      scales: [1],
      hash: 'd759e235e88e47f838062c7ab97308b1',
      name: 'Inter-Bold',
      type: 'otf',
      fileHashes: ['d759e235e88e47f838062c7ab97308b1'],
    })
  },
  2264,
  [391],
  '../../packages/font-inter/otf/Inter-Bold.otf'
)
__r(30)
__r(0)
//# sourceMappingURL=http://127.0.0.1:8081/index.map?platform=ios&dev=true&hot=false
//# sourceURL=http://127.0.0.1:8081/index.bundle?platform=ios&dev=true&hot=false
