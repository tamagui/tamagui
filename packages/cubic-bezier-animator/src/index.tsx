...
export function animate(param: AnimateProps) {
  ...
  function frame(currentTime) {
    ...
    const x = toX ? easing(progress) * fromX! + toX : undefined // apply the easing function to the progress
    const y = toY ? easing(progress) * fromY! + toY : undefined
    const scaleX = toScaleX ? easing(progress) * fromScaleX! + toScaleX : undefined
    const scaleY = toScaleY ? easing(progress) * fromScaleY! + toScaleY : undefined
