...
describe('getSplitStyles', () => {
  ...
  test(`group container queries generate @supports and @container`, () => {
    ...
    expect(styles.rulesToInsert[0].rules[0]).toMatchInlineSnapshot('"@supports (contain: size) {@container testy (max-width: 800px){:root:root .t_group_testy  ._col-_grouptesty-sm_red{color:red;}}}"')
  })
