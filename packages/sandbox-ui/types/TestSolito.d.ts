...
export declare const TextLink: import("react").ForwardRefExoticComponent<Pick<LinkCoreProps, "target" | "href"> & Omit<import("react-native").TextProps, "children" | "onLayout" | keyof import("react-native").GestureResponderHandlers | "style"> & import("@tamagui/web").ExtendBaseTextProps & import("@tamagui/web").WebOnlyPressEvents & {
