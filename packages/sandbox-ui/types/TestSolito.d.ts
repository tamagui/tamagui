...
export declare const TextLink: import("react").ForwardRefExoticComponent<Pick<LinkProps, "href" | "target"> & Omit<import("tamagui").TextNonStyleProps, "size" | keyof import("@tamagui/web").TextStylePropsBase | "unstyled"> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").TextStylePropsBase> & {
